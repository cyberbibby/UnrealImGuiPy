...
#else
#if IMGUI_BUNDLE_PYTHON_API // BIBBY-CHANGE - Compatibility with ImGui Bundle.
	BundleHybridCallback<BundleHybridStr(ImGuiContext*)> mGetClipboardTextFn = nullptr;
	BundleHybridCallback<void(ImGuiContext*, const char*)> mSetClipboardTextFn = nullptr;
#else
