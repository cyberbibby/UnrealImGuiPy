...
#ifndef IMGUI_PYBIND11_ARRAY_VIEW_HELPER
#define IMGUI_PYBIND11_ARRAY_VIEW_HELPER
template <typename Owner, typename T, size_t N>
py::array_t<T> pybind11_array_view(Owner& owner, T (&data)[N])
{
    return py::array_t<T>(
...
struct type_caster<ImGuiNpBuffer> {
    PYBIND11_TYPE_CASTER(ImGuiNpBuffer, const_name("numpy.ndarray"));
    ...
    static handle cast(const ImGuiNpBuffer& buf, return_value_policy policy, handle parent) {
        try {
            ...
            py::object base = parent ? py::reinterpret_borrow<py::object>(parent) : py::none();
            py::array_t<uint8_t> array(static_cast<py::ssize_t>(buf.Size), buf.Data, base);
            return array.release();
        }
        catch (const std::exception& e) {
            PyErr_WarnFormat(PyExc_Warning, 1, "ImGuiNpBuffer caster cast exception: %s", e.what());
...
py::class_<ImVec2>* pyClassImVec2Ptr  = nullptr;
py::class_<ImVec4>* pyClassImVec4Ptr = nullptr;
py::class_<ImColor>* pyClassImColorPtr = nullptr;
py::class_<ImFontAtlas>* pyClassImFontAtlasPtr = nullptr;

void imgui_manual_binding(py::module_& m);
...
void py_init_module_imgui_main(py::module_& m)
{
    ...
    auto pyClassImTextureRef =
        ...
        .def_readwrite("_tex_data", &ImTextureRef::_TexData, "A texture, generally owned by a ImFontAtlas. Will convert to ImTextureID during render loop, after texture has been uploaded.")
        .def_readwrite("_tex_id", &ImTextureRef::_TexID, "_OR_ Low-level backend texture identifier, if already uploaded or created by user/app. Generally provided to e.g. ImGui::Image() calls.")
        ;
    ...
    m.def("get_platform_io",
        py::overload_cast<>(ImGui::GetPlatformIO),
    ...
    m.def("show_demo_window_maybe_docked",
        ...
        py::arg("create_window"), py::arg("p_open").none() = py::none(), py::arg("initial_extra_flags") = 0, py::arg("window_pos").none() = py::none(), py::arg("window_size").none() = py::none(),
    ...
    m.def("begin",
        ...
        },     py::arg("name"), py::arg("p_open").none() = py::none(), py::arg("flags") = 0);
    ...
    m.def("begin_child",
        ...
        py::arg("str_id"), py::arg("size").none() = py::none(), py::arg("child_flags") = 0, py::arg("window_flags") = 0,
    ...
    m.def("begin_child",
        ...
        py::arg("id_"), py::arg("size").none() = py::none(), py::arg("child_flags") = 0, py::arg("window_flags") = 0,
        "Python bindings defaults:\n    If size is None, then its default value will be: ImVec2(0, 0)");
    ...
    m.def("set_next_window_pos",
        ...
        py::arg("pos"), py::arg("cond") = 0, py::arg("pivot").none() = py::none(),
    ...
    m.def("push_font",
        py::overload_cast<std::optional<ImFont*>, float>(ImGui::PushFont),
        py::arg("font").none(), py::arg("font_size_base_unscaled"),
    ...
    m.def("text_unformatted",
        ...
        py::arg("text"), py::arg("text_end").none() = py::none(),
    ...
    m.def("button",
        ...
        py::arg("label"), py::arg("size").none() = py::none(),
        "Python bindings defaults:\n    If size is None, then its default value will be: ImVec2(0, 0)\n\n button");
    ...
    m.def("progress_bar",
        ...
        py::arg("fraction"), py::arg("size_arg").none() = py::none(), py::arg("overlay").none() = py::none(),
    ...
    m.def("text_link_open_url",
        ...
        py::arg("label"), py::arg("url").none() = py::none(),
    ...
    m.def("image",
        ...
        py::arg("tex_ref"), py::arg("image_size"), py::arg("uv0").none() = py::none(), py::arg("uv1").none() = py::none(),
        "Python bindings defaults:\n    If any of the params below is None, then its default value below will be used:\n        * uv0: ImVec2(0, 0)\n        * uv1: ImVec2(1, 1)");
    ...
    m.def("image_with_bg",
        ...
        py::arg("tex_ref"), py::arg("image_size"), py::arg("uv0").none() = py::none(), py::arg("uv1").none() = py::none(), py::arg("bg_col").none() = py::none(), py::arg("tint_col").none() = py::none(),
    ...
    m.def("image_button",
        ...
        py::arg("str_id"), py::arg("tex_ref"), py::arg("image_size"), py::arg("uv0").none() = py::none(), py::arg("uv1").none() = py::none(), py::arg("bg_col").none() = py::none(), py::arg("tint_col").none() = py::none(),
        "Python bindings defaults:\n    If any of the params below is None, then its default value below will be used:\n        * uv0: ImVec2(0, 0)\n        * uv1: ImVec2(1, 1)\n        * bg_col: ImVec4(0, 0, 0, 0)\n        * tint_col: ImVec4(1, 1, 1, 1)");
    ...
    m.def("drag_float_range2",
        ...
        },     py::arg("label"), py::arg("v_current_min"), py::arg("v_current_max"), py::arg("v_speed") = 1.0f, py::arg("v_min") = 0.0f, py::arg("v_max") = 0.0f, py::arg("format") = "%.3f", py::arg("format_max").none() = py::none(), py::arg("flags") = 0);
    ...
    m.def("drag_int_range2",
        ...
        },     py::arg("label"), py::arg("v_current_min"), py::arg("v_current_max"), py::arg("v_speed") = 1.0f, py::arg("v_min") = 0, py::arg("v_max") = 0, py::arg("format") = "%d", py::arg("format_max").none() = py::none(), py::arg("flags") = 0);
    ...
    m.def("drag_scalar",
        ...
        },     py::arg("label"), py::arg("data_type"), py::arg("p_data"), py::arg("v_speed") = 1.0f, py::arg("p_min") = py::none(), py::arg("p_max") = py::none(), py::arg("format").none() = py::none(), py::arg("flags") = 0);
    ...
    m.def("drag_scalar_n",
        ...
        },     py::arg("label"), py::arg("data_type"), py::arg("p_data"), py::arg("components"), py::arg("v_speed") = 1.0f, py::arg("p_min") = py::none(), py::arg("p_max") = py::none(), py::arg("format").none() = py::none(), py::arg("flags") = 0);
    ...
    m.def("slider_float2",
        py::overload_cast<const char *, ImVec2, float, float, const char *, ImGuiSliderFlags>(ImGui::SliderFloat2), py::arg("label"), py::arg("v"), py::arg("v_min"), py::arg("v_max"), py::arg("format") = "%.3f", py::arg("flags") = 0);
    // #ifdef IMGUI_BUNDLE_PYTHON_API
    //
    // #endif
    //
    ...
    m.def("slider_float4",
        py::overload_cast<const char *, ImVec4, float, float, const char *, ImGuiSliderFlags>(ImGui::SliderFloat4), py::arg("label"), py::arg("v"), py::arg("v_min"), py::arg("v_max"), py::arg("format") = "%.3f", py::arg("flags") = 0);
    // #ifdef IMGUI_BUNDLE_PYTHON_API
    //
    // #endif
    //
    ...
    m.def("slider_scalar",
        ...
        },     py::arg("label"), py::arg("data_type"), py::arg("p_data"), py::arg("p_min"), py::arg("p_max"), py::arg("format").none() = py::none(), py::arg("flags") = 0);
    ...
    m.def("slider_scalar_n",
        ...
        },     py::arg("label"), py::arg("data_type"), py::arg("p_data"), py::arg("components"), py::arg("p_min"), py::arg("p_max"), py::arg("format").none() = py::none(), py::arg("flags") = 0);
    ...
    m.def("v_slider_scalar",
        ...
        },     py::arg("label"), py::arg("size"), py::arg("data_type"), py::arg("p_data"), py::arg("p_min"), py::arg("p_max"), py::arg("format").none() = py::none(), py::arg("flags") = 0);
    ...
    m.def("input_float2",
        py::overload_cast<const char *, ImVec2, const char *, ImGuiInputTextFlags>(ImGui::InputFloat2), py::arg("label"), py::arg("v"), py::arg("format") = "%.3f", py::arg("flags") = 0);
    // #ifdef IMGUI_BUNDLE_PYTHON_API
    //
    // #endif
    //
    ...
    m.def("input_float4",
        py::overload_cast<const char *, ImVec4, const char *, ImGuiInputTextFlags>(ImGui::InputFloat4), py::arg("label"), py::arg("v"), py::arg("format") = "%.3f", py::arg("flags") = 0);
    // #ifdef IMGUI_BUNDLE_PYTHON_API
    //
    // #endif
    //
    ...
    m.def("input_scalar",
        ...
        },     py::arg("label"), py::arg("data_type"), py::arg("p_data"), py::arg("p_step") = py::none(), py::arg("p_step_fast") = py::none(), py::arg("format").none() = py::none(), py::arg("flags") = 0);
    ...
    m.def("input_scalar_n",
        ...
        },     py::arg("label"), py::arg("data_type"), py::arg("p_data"), py::arg("components"), py::arg("p_step") = py::none(), py::arg("p_step_fast") = py::none(), py::arg("format").none() = py::none(), py::arg("flags") = 0);
    ...
    m.def("color_edit3",
        py::overload_cast<const std::string &, ImVec4, ImGuiColorEditFlags>(ImGui::ColorEdit3), py::arg("label"), py::arg("col"), py::arg("flags") = 0);
    ...
    m.def("color_edit4",
        py::overload_cast<const std::string &, ImVec4, ImGuiColorEditFlags>(ImGui::ColorEdit4), py::arg("label"), py::arg("col"), py::arg("flags") = 0);
    // #ifdef IMGUI_BUNDLE_PYTHON_API
    //
    // #endif
    //
    ...
    m.def("color_picker3",
        py::overload_cast<const char *, ImVec4, ImGuiColorEditFlags>(ImGui::ColorPicker3), py::arg("label"), py::arg("col"), py::arg("flags") = 0);
    ...
    m.def("color_picker4",
        py::overload_cast<const std::string &, ImVec4, ImGuiColorEditFlags, std::optional<ImVec4>>(ImGui::ColorPicker4), py::arg("label"), py::arg("col"), py::arg("flags") = 0, py::arg("ref_col").none() = py::none());
    // #ifdef IMGUI_BUNDLE_PYTHON_API
    //
    // #endif
    //
    ...
    m.def("color_button",
        ...
        py::arg("desc_id"), py::arg("col"), py::arg("flags") = 0, py::arg("size").none() = py::none(),
    ...
    m.def("selectable",
        ...
        py::arg("label"), py::arg("p_selected"), py::arg("flags") = 0, py::arg("size").none() = py::none(),
    ...
    m.def("plot_lines",
        [](const char * label, py::array_t<float, py::array::c_style> values, int values_offset = 0, std::optional<std::string> overlay_text = std::nullopt, float scale_min = FLT_MAX, float scale_max = FLT_MAX, const std::optional<const ImVec2> & graph_size = std::nullopt, int stride = -1)
        {
            auto PlotLines_adapt_c_buffers = [](const char * label, py::array_t<float, py::array::c_style> values, int values_offset = 0, const char * overlay_text = NULL, float scale_min = FLT_MAX, float scale_max = FLT_MAX, ImVec2 graph_size = ImVec2(0, 0), int stride = -1)
            {
                ...
                // convert pybind11 array to C standard buffer (const)
                const void * values_from_pyarray = values.data();
                size_t values_count = values.shape(0);
                // pybind11 array_t<float, c_style> validates dtype and C-contiguity during argument conversion.
                //   - Step 2: check the size of the type
                size_t size_python_1 = values.itemsize();
            ...
            auto PlotLines_adapt_mutable_param_with_default_value = [&PlotLines_adapt_c_buffers](const char * label, py::array_t<float, py::array::c_style> values, int values_offset = 0, const char * overlay_text = NULL, float scale_min = FLT_MAX, float scale_max = FLT_MAX, const std::optional<const ImVec2> & graph_size = std::nullopt, int stride = -1)
            {
            ...
            auto PlotLines_adapt_const_char_pointer_with_default_null = [&PlotLines_adapt_mutable_param_with_default_value](const char * label, py::array_t<float, py::array::c_style> values, int values_offset = 0, std::optional<std::string> overlay_text = std::nullopt, float scale_min = FLT_MAX, float scale_max = FLT_MAX, const std::optional<const ImVec2> & graph_size = std::nullopt, int stride = -1)
            {
        ...
        py::arg("label"), py::arg("values"), py::arg("values_offset") = 0, py::arg("overlay_text").none() = py::none(), py::arg("scale_min") = FLT_MAX, py::arg("scale_max") = FLT_MAX, py::arg("graph_size").none() = py::none(), py::arg("stride") = -1,
        "Python bindings defaults:\n    If graph_size is None, then its default value will be: ImVec2(0, 0)");

    m.def("plot_histogram",
        [](const char * label, py::array_t<float, py::array::c_style> values, int values_offset = 0, std::optional<std::string> overlay_text = std::nullopt, float scale_min = FLT_MAX, float scale_max = FLT_MAX, const std::optional<const ImVec2> & graph_size = std::nullopt, int stride = -1)
        {
            auto PlotHistogram_adapt_c_buffers = [](const char * label, py::array_t<float, py::array::c_style> values, int values_offset = 0, const char * overlay_text = NULL, float scale_min = FLT_MAX, float scale_max = FLT_MAX, ImVec2 graph_size = ImVec2(0, 0), int stride = -1)
            {
                // Check if the array is 1D and C-contiguous
                if (! (values.ndim() == 1 && values.strides(0) == values.itemsize()))
                    throw std::runtime_error("The array must be 1D and contiguous");
            ...
            auto PlotHistogram_adapt_mutable_param_with_default_value = [&PlotHistogram_adapt_c_buffers](const char * label, py::array_t<float, py::array::c_style> values, int values_offset = 0, const char * overlay_text = NULL, float scale_min = FLT_MAX, float scale_max = FLT_MAX, const std::optional<const ImVec2> & graph_size = std::nullopt, int stride = -1)
            {
            ...
            auto PlotHistogram_adapt_const_char_pointer_with_default_null = [&PlotHistogram_adapt_mutable_param_with_default_value](const char * label, py::array_t<float, py::array::c_style> values, int values_offset = 0, std::optional<std::string> overlay_text = std::nullopt, float scale_min = FLT_MAX, float scale_max = FLT_MAX, const std::optional<const ImVec2> & graph_size = std::nullopt, int stride = -1)
            {
                const char * overlay_text_adapt_default_null = nullptr;
                if (overlay_text.has_value())
                    overlay_text_adapt_default_null = overlay_text.value().c_str();
    ...
    m.def("value",
        ...
        },     py::arg("prefix"), py::arg("v"), py::arg("float_format").none() = py::none());
    ...
    m.def("menu_item_simple",
        ...
        py::arg("label"), py::arg("shortcut").none() = py::none(), py::arg("selected") = false, py::arg("enabled") = true,
        "(private API)");
    // #endif
    //
    ...
    m.def("open_popup_on_item_click",
        ...
        py::arg("str_id").none() = py::none(), py::arg("popup_flags") = 0,
    ...
    m.def("begin_table",
        ...
        py::arg("str_id"), py::arg("columns"), py::arg("flags") = 0, py::arg("outer_size").none() = py::none(), py::arg("inner_width") = 0.0f,
    ...
    m.def("table_get_row_index",
        py::overload_cast<>(ImGui::TableGetRowIndex), "return current row index (header rows are accounted for)");
    ...
    m.def("columns",
        ...
        },     py::arg("count") = 1, py::arg("id_").none() = py::none(), py::arg("borders") = true);
    ...
    m.def("begin_tab_item",
        ...
        py::arg("label"), py::arg("p_open").none() = py::none(), py::arg("flags") = 0,
    ...
    m.def("dock_space",
        ...
        py::arg("dockspace_id"), py::arg("size").none() = py::none(), py::arg("flags") = 0, py::arg("window_class") = py::none(),
        "Python bindings defaults:\n    If size is None, then its default value will be: ImVec2(0, 0)");
    ...
    m.def("log_to_file",
        ...
        py::arg("auto_open_depth") = -1, py::arg("filename").none() = py::none(),
    ...
    m.def("calc_text_size",
        ...
        py::arg("text"), py::arg("text_end").none() = py::none(), py::arg("hide_text_after_double_hash") = false, py::arg("wrap_width") = -1.0f,
        "Text Utilities");
    ...
    auto pyClassImVector_ImTextureData_ptr =
        py::class_<ImVector<ImTextureData *>>
        ...
        //
        .def(py::init<>())
        .def(py::init<const ImVector<ImTextureData *> &>(),
            py::arg("src"))
        .def("clear",
        ...
        .def("__getitem__",
            py::overload_cast<int>(&ImVector<ImTextureData *>::operator[], py::const_),
            py::arg("i"),
            "(private API)",
            py::return_value_policy::reference)
        .def("__getitem__",
            py::overload_cast<int>(&ImVector<ImTextureData *>::operator[]),
            py::arg("i"),
            "(private API)",
            py::return_value_policy::reference)
        .def("push_back",
    ...
    auto pyClassImVector_ImTextureRef =
        py::class_<ImVector<ImTextureRef>>
        ...
        //
        .def(py::init<>())
        .def(py::init<const ImVector<ImTextureRef> &>(),
            py::arg("src"))
        .def("clear",
        ...
        .def("__getitem__",
            py::overload_cast<int>(&ImVector<ImTextureRef>::operator[], py::const_),
            py::arg("i"),
            "(private API)",
            py::return_value_policy::reference)
        .def("__getitem__",
            py::overload_cast<int>(&ImVector<ImTextureRef>::operator[]),
            py::arg("i"),
            "(private API)",
            py::return_value_policy::reference)
        .def("push_back",
    ...
    auto pyClassImVector_ImTextureRect =
        py::class_<ImVector<ImTextureRect>>
        ...
        //
        .def(py::init<>())
        .def(py::init<const ImVector<ImTextureRect> &>(),
            py::arg("src"))
        .def("clear",
        ...
        .def("__getitem__",
            py::overload_cast<int>(&ImVector<ImTextureRect>::operator[], py::const_),
            py::arg("i"),
            "(private API)",
            py::return_value_policy::reference)
        .def("__getitem__",
            py::overload_cast<int>(&ImVector<ImTextureRect>::operator[]),
            py::arg("i"),
            "(private API)",
            py::return_value_policy::reference)
        .def("push_back",
    ...
    auto pyClassImGuiStyle =
        py::class_<ImGuiStyle>
            (m, "Style", "")
        .def_readwrite("font_size_base", &ImGuiStyle::FontSizeBase, "Current base font size before external global factors are applied. Use PushFont(None, size) to modify. Use ImGui::GetFontSize() to obtain scaled value.")
        .def_readwrite("font_scale_main", &ImGuiStyle::FontScaleMain, "Main global scale factor. May be set by application once, or exposed to end-user.")
        .def_readwrite("font_scale_dpi", &ImGuiStyle::FontScaleDpi, "Additional global scale factor from viewport/monitor contents scale. In docking branch: when io.ConfigDpiScaleFonts is enabled, this is automatically overwritten when changing monitor DPI.")
        ...
        .def_readwrite("window_border_hover_padding", &ImGuiStyle::WindowBorderHoverPadding, "Hit-testing extent outside/inside resizing border. Also extend determination of hovered window. Generally meaningfully larger than WindowBorderSize to make it easy to reach borders.")
        ...
        .def_readwrite("scrollbar_padding", &ImGuiStyle::ScrollbarPadding, "Padding of scrollbar grab within its frame (same for both axes).")
        ...
        .def_readwrite("image_rounding", &ImGuiStyle::ImageRounding, "Rounding of Image() calls.")
        .def_readwrite("image_border_size", &ImGuiStyle::ImageBorderSize, "Thickness of border around Image() calls.")
        ...
        .def_readwrite("tab_min_width_base", &ImGuiStyle::TabMinWidthBase, "Minimum tab width, to make tabs larger than their contents. TabBar buttons are not affected.")
        .def_readwrite("tab_min_width_shrink", &ImGuiStyle::TabMinWidthShrink, "Minimum tab width after shrinking, when using ImGuiTabBarFlags_FittingPolicyMixed policy.")
        .def_readwrite("tab_close_button_min_width_selected", &ImGuiStyle::TabCloseButtonMinWidthSelected, "-1: always visible. 0.0: visible when hovered. >0.0: visible when hovered if minimum width. FLT_MAX: never shrink, will behave like ImGuiTabBarFlags_FittingPolicyScroll.")
        .def_readwrite("tab_close_button_min_width_unselected", &ImGuiStyle::TabCloseButtonMinWidthUnselected, "-1: always visible. 0.0: visible when hovered. >0.0: visible when hovered if minimum width. FLT_MAX: never show close button when unselected.")
        ...
        .def_readwrite("tree_lines_flags", &ImGuiStyle::TreeLinesFlags, "Default way to draw lines connecting TreeNode hierarchy. ImGuiTreeNodeFlags_DrawLinesNone or ImGuiTreeNodeFlags_DrawLinesFull or ImGuiTreeNodeFlags_DrawLinesToNodes.")
        .def_readwrite("tree_lines_size", &ImGuiStyle::TreeLinesSize, "Thickness of outlines when using ImGuiTreeNodeFlags_DrawLines.")
        .def_readwrite("tree_lines_rounding", &ImGuiStyle::TreeLinesRounding, "Radius of lines connecting child nodes to the vertical line.")
        .def_readwrite("drag_drop_target_rounding", &ImGuiStyle::DragDropTargetRounding, "Radius of the drag and drop target frame. When <0.0: use FrameRounding.")
        .def_readwrite("drag_drop_target_border_size", &ImGuiStyle::DragDropTargetBorderSize, "Thickness of the drag and drop target border.")
        .def_readwrite("drag_drop_target_padding", &ImGuiStyle::DragDropTargetPadding, "Size to expand the drag and drop target from actual target item size.")
        .def_readwrite("color_marker_size", &ImGuiStyle::ColorMarkerSize, "Size of R/G/B/A color markers for ColorEdit4() and for Drags/Sliders when using ImGuiSliderFlags_ColorMarkers.")
        ...
        .def_readwrite("separator_size", &ImGuiStyle::SeparatorSize, "Thickness of border in Separator(). Must be >= 1.0.")
        ...
        .def_readwrite("docking_node_has_close_button", &ImGuiStyle::DockingNodeHasCloseButton, "Docking node has their own CloseButton() to close all docked windows.")
        ...
        .def_readwrite("hover_flags_for_tooltip_nav", &ImGuiStyle::HoverFlagsForTooltipNav, "Default flags when using IsItemHovered(ImGuiHoveredFlags_ForTooltip) or BeginItemTooltip()/SetItemTooltip() while using keyboard/gamepad.")
        .def_readwrite("_main_scale", &ImGuiStyle::_MainScale, "FIXME-WIP: Reference scale, as applied by ScaleAllSizes(). PLEASE DO NOT USE THIS FOR NOW.")
        .def_readwrite("_next_frame_font_size_base", &ImGuiStyle::_NextFrameFontSizeBase, "FIXME: Temporary hack until we finish remaining work.")
        // #ifdef IMGUI_BUNDLE_PYTHON_API
        //
        .def("color_",
            &ImGuiStyle::Color_,
    ...
    auto pyClassImGuiIO =
        ...
        .def_readwrite("display_size", &ImGuiIO::DisplaySize, "<unset>          // Main display size, in pixels (== GetMainViewport()->Size). May change every frame.")
        .def_readwrite("display_framebuffer_scale", &ImGuiIO::DisplayFramebufferScale, "= (1, 1)         // Main display density. For retina display where window coordinates are different from framebuffer coordinates. This will affect font density + will end up in ImDrawData::FramebufferScale.")
        ...
        .def_readwrite("config_docking_no_docking_over", &ImGuiIO::ConfigDockingNoDockingOver, "= False          // Simplified docking mode: disable window merging into a same tab-bar, so docking is limited to splitting windows.")
        ...
        .def_readwrite("config_viewports_platform_focus_sets_focus", &ImGuiIO::ConfigViewportsPlatformFocusSetsImGuiFocus, "= True // When a platform window is focused (e.g. using Alt+Tab, clicking Platform Title Bar), apply corresponding focus on imgui windows (may clear focus/active id from imgui windows location in other platform windows). In principle this is better enabled but we provide an opt-out, because some Linux window managers tend to eagerly focus windows (e.g. on mouse hover, or even a simple window pos/size change).")
        .def_readwrite("config_dpi_scale_fonts", &ImGuiIO::ConfigDpiScaleFonts, "= False          // [EXPERIMENTAL] Automatically overwrite style.FontScaleDpi when Monitor DPI changes. This will scale fonts but _NOT_ scale sizes/padding for now.")
        .def_readwrite("config_dpi_scale_viewports", &ImGuiIO::ConfigDpiScaleViewports, "= False          // [EXPERIMENTAL] Scale Dear ImGui and Platform Windows when Monitor DPI changes.")
        ...
        .def_readwrite("config_input_text_enter_keep_active", &ImGuiIO::ConfigInputTextEnterKeepActive, "= False          // [BETA] Pressing Enter will reactivate item and select all text (single-line only).")
        ...
        .def_readwrite("config_debug_highlight_id_conflicts", &ImGuiIO::ConfigDebugHighlightIdConflicts, "= True           // Highlight and show an error message popup when multiple items have conflicting identifiers.")
        .def_readwrite("config_debug_highlight_id_conflicts_show_item_picker", &ImGuiIO::ConfigDebugHighlightIdConflictsShowItemPicker, "=True // Show \"Item Picker\" button in aforementioned popup.")
        ...
        .def_property_readonly("mouse_down",
            [](ImGuiIO &self) -> py::array_t<bool>
            {
                return pybind11_array_view(self, self.MouseDown);
            },
        ...
        .def_readwrite("key_ctrl", &ImGuiIO::KeyCtrl, "Keyboard modifier down: Ctrl (non-macOS), Cmd (macOS)")
        ...
        .def_readwrite("key_super", &ImGuiIO::KeySuper, "Keyboard modifier down: Windows/Super (non-macOS), Ctrl (macOS)")
        ...
        .def_property_readonly("mouse_clicked_time",
            [](ImGuiIO &self) -> py::array_t<double>
            {
                return pybind11_array_view(self, self.MouseClickedTime);
            },
            "Time of last click (used to figure out double-click)")
        .def_property_readonly("mouse_clicked",
            [](ImGuiIO &self) -> py::array_t<bool>
            {
                return pybind11_array_view(self, self.MouseClicked);
            },
            "Mouse button went from !Down to Down (same as MouseClickedCount[x] != 0)")
        .def_property_readonly("mouse_double_clicked",
            [](ImGuiIO &self) -> py::array_t<bool>
            {
                return pybind11_array_view(self, self.MouseDoubleClicked);
            },
            "Has mouse button been double-clicked? (same as MouseClickedCount[x] == 2)")
        .def_property_readonly("mouse_clicked_count",
            [](ImGuiIO &self) -> py::array_t<ImU16>
            {
                return pybind11_array_view(self, self.MouseClickedCount);
            },
            "== 0 (not clicked), == 1 (same as MouseClicked[]), == 2 (double-clicked), == 3 (triple-clicked) etc. when going from !Down to Down")
        .def_property_readonly("mouse_clicked_last_count",
            [](ImGuiIO &self) -> py::array_t<ImU16>
            {
                return pybind11_array_view(self, self.MouseClickedLastCount);
            },
            "Count successive number of clicks. Stays valid after mouse release. Reset after another click is done.")
        .def_property_readonly("mouse_released",
            [](ImGuiIO &self) -> py::array_t<bool>
            {
                return pybind11_array_view(self, self.MouseReleased);
            },
            "Mouse button went from Down to !Down")
        .def_property_readonly("mouse_released_time",
            [](ImGuiIO &self) -> py::array_t<double>
            {
                return pybind11_array_view(self, self.MouseReleasedTime);
            },
        ...
        .def_property_readonly("mouse_down_owned",
            [](ImGuiIO &self) -> py::array_t<bool>
            {
                return pybind11_array_view(self, self.MouseDownOwned);
            },
        ...
        .def_property_readonly("mouse_down_owned_unless_popup_close",
            [](ImGuiIO &self) -> py::array_t<bool>
            {
                return pybind11_array_view(self, self.MouseDownOwnedUnlessPopupClose);
            },
        ...
        .def_property_readonly("mouse_down_duration",
            [](ImGuiIO &self) -> py::array_t<float>
            {
                return pybind11_array_view(self, self.MouseDownDuration);
            },
            "Duration the mouse button has been down (0.0 == just clicked)")
        .def_property_readonly("mouse_down_duration_prev",
            [](ImGuiIO &self) -> py::array_t<float>
            {
                return pybind11_array_view(self, self.MouseDownDurationPrev);
            },
            "Previous time the mouse button has been down")
        .def_property_readonly("mouse_drag_max_distance_sqr",
            [](ImGuiIO &self) -> py::array_t<float>
            {
                return pybind11_array_view(self, self.MouseDragMaxDistanceSqr);
            },
    ...
    auto pyClassImGuiInputTextCallbackData =
        ...
        .def_readwrite("id_", &ImGuiInputTextCallbackData::ID, "Widget ID                            // Read-only")
        ...
        .def_readwrite("event_activated", &ImGuiInputTextCallbackData::EventActivated, "Input field just got activated       // Read-only    // [Always]")
        ...
        .def_readwrite("cursor_pos", &ImGuiInputTextCallbackData::CursorPos, "// Read-write   // [Completion,History,Always,CharFilter]")
        .def_readwrite("selection_start", &ImGuiInputTextCallbackData::SelectionStart, "// Read-write   // [Completion,History,Always,CharFilter] == to SelectionEnd when no selection")
        .def_readwrite("selection_end", &ImGuiInputTextCallbackData::SelectionEnd, "// Read-write   // [Completion,History,Always,CharFilter]")
        .def(py::init<>())
        .def("delete_chars",
        ...
        .def("insert_chars",
            ...
            },     py::arg("pos"), py::arg("text"), py::arg("text_end").none() = py::none())
        .def("select_all",
    ...
    auto pyClassImGuiSizeCallbackData =
        ...
        py::arg("pos").none() = py::none(), py::arg("current_size").none() = py::none(), py::arg("desired_size").none() = py::none()
        )
    ...
    auto pyClassImGuiWindowClass =
        ...
        .def_readwrite("platform_icon_data", &ImGuiWindowClass::PlatformIconData, "[EXPERIMENTAL] Pass opaque data for Platform backend to handle.")
        .def(py::init<>())
        ;
    ...
    pyClassImGuiTextFilter.def_property("input_buf",
    ...
    auto pyClassImGuiTextBuffer =
        ...
        .def("append",
            ...
            },     py::arg("str"), py::arg("str_end").none() = py::none())
        .def("appendf",
    ...
    auto pyEnumListClipperFlags_ =
        py::enum_<ImGuiListClipperFlags_>(m, "ListClipperFlags_", py::arithmetic(), "Flags for ImGuiListClipper (currently not fully exposed in function calls: a future refactor will likely add this to ImGuiListClipper::Begin function equivalent)")
    ...
    auto pyClassImGuiListClipper =
        ...
        .def_readwrite("user_index", &ImGuiListClipper::UserIndex, "Helper storage for user convenience/code. Optional, and otherwise unused if you don't use it.")
        ...
        .def_readwrite("flags", &ImGuiListClipper::Flags, "[Internal] Flags, currently not yet well exposed.")
        ...
        .def_readwrite("ctx", &ImGuiListClipper::Ctx, "[Internal] Parent UI context")
    ...
    auto pyClassImGuiMultiSelectIO =
        ...
        py::arg("requests").none() = py::none(), py::arg("range_src_item").none() = py::none(), py::arg("nav_id_item").none() = py::none(), py::arg("nav_id_selected") = bool(), py::arg("range_src_reset") = bool(), py::arg("items_count") = int()
        )
    ...
    auto pyClassImGuiSelectionRequest =
        ...
        py::arg("type") = ImGuiSelectionRequestType(), py::arg("selected") = bool(), py::arg("range_direction") = ImS8(), py::arg("range_first_item").none() = py::none(), py::arg("range_last_item").none() = py::none()
        )
    ...
    auto pyClassImDrawCmd =
        ...
        .def_readwrite("tex_ref", &ImDrawCmd::TexRef, "16   // Reference to a font/texture atlas (where backend called ImTextureData::SetTexID()) or to a user-provided texture ID (via e.g. ImGui::Image() calls). Both will lead to a ImTextureID value.")
    ...
    auto pyClassImDrawVert =
        ...
        py::arg("pos").none() = py::none(), py::arg("uv").none() = py::none(), py::arg("col") = ImU32()
        )
    ...
    auto pyClassImDrawCmdHeader =
        ...
        py::arg("clip_rect").none() = py::none(), py::arg("tex_ref").none() = py::none()
        )
    ...
    auto pyClassImDrawChannel =
        ...
        py::arg("_cmd_buffer").none() = py::none(), py::arg("_idx_buffer").none() = py::none()
        )
    ...
    auto pyClassImDrawList =
        ...
        .def_readwrite("_texture_stack", &ImDrawList::_TextureStack, "[Internal]")
        .def_readwrite("_callbacks_data_buf", &ImDrawList::_CallbacksDataBuf, "[Internal]")
        ...
        .def("push_texture",
            &ImDrawList::PushTexture, py::arg("tex_ref"))
        .def("pop_texture",
        ...
        .def("add_line_h",
            &ImDrawList::AddLineH, py::arg("min_x"), py::arg("max_x"), py::arg("y"), py::arg("col"), py::arg("thickness") = 1.0f)
        .def("add_rect",
            ...
            py::arg("p_min"), py::arg("p_max"), py::arg("col"), py::arg("rounding") = 0.0f, py::arg("thickness") = 1.0f, py::arg("flags") = 0,
        ...
        .def("add_text",
            ...
            },     py::arg("pos"), py::arg("col"), py::arg("text_begin"), py::arg("text_end").none() = py::none())
        .def("add_text",
            ...
            },     py::arg("font"), py::arg("font_size"), py::arg("pos"), py::arg("col"), py::arg("text_begin"), py::arg("text_end").none() = py::none(), py::arg("wrap_width") = 0.0f, py::arg("cpu_fine_clip_rect") = py::none())
        ...
        .def("add_polyline",
            ...
            },     py::arg("points"), py::arg("col"), py::arg("thickness"), py::arg("flags"))
        ...
        .def("add_image",
            ...
            py::arg("tex_ref"), py::arg("p_min"), py::arg("p_max"), py::arg("uv_min").none() = py::none(), py::arg("uv_max").none() = py::none(), py::arg("col") = IM_COL32_WHITE,
            "Python bindings defaults:\n    If any of the params below is None, then its default value below will be used:\n        * uv_min: ImVec2(0, 0)\n        * uv_max: ImVec2(1, 1)")
        .def("add_image_quad",
            ...
            py::arg("tex_ref"), py::arg("p1"), py::arg("p2"), py::arg("p3"), py::arg("p4"), py::arg("uv1").none() = py::none(), py::arg("uv2").none() = py::none(), py::arg("uv3").none() = py::none(), py::arg("uv4").none() = py::none(), py::arg("col") = IM_COL32_WHITE,
            "Python bindings defaults:\n    If any of the params below is None, then its default value below will be used:\n        * uv1: ImVec2(0, 0)\n        * uv2: ImVec2(1, 0)\n        * uv3: ImVec2(1, 1)\n        * uv4: ImVec2(0, 1)")
        .def("add_image_rounded",
            &ImDrawList::AddImageRounded, py::arg("tex_ref"), py::arg("p_min"), py::arg("p_max"), py::arg("uv_min"), py::arg("uv_max"), py::arg("col"), py::arg("rounding"), py::arg("flags") = 0)
        .def("path_clear",
        ...
        .def("_set_draw_list_shared_data",
            py::overload_cast<ImDrawListSharedData *>(&ImDrawList::_SetDrawListSharedData), py::arg("data"))
        ...
        .def("_set_texture",
            &ImDrawList::_SetTexture, py::arg("tex_ref"))
    ...
    auto pyClassImDrawData =
        ...
        .def_readwrite("cmd_lists_count", &ImDrawData::CmdListsCount, "== CmdLists.Size. (OBSOLETE: exists for legacy reasons). Number of ImDrawList* to render.")
        ...
        .def_readwrite("framebuffer_scale", &ImDrawData::FramebufferScale, "Amount of pixels for each unit of DisplaySize. Copied from viewport->FramebufferScale (== io.DisplayFramebufferScale for main viewport). Generally (1,1) on normal display, (2,2) on OSX with Retina display.")
        ...
        .def_readwrite("textures", &ImDrawData::Textures, "List of textures to update. Most of the times the list is shared by all ImDrawData, has only 1 texture and it doesn't need any update. This almost always points to ImGui::GetPlatformIO().Textures[]. May be overridden or set to None if you want to manually update textures.")
        .def(py::init<>(),
            "Functions")
        .def("clear",
            &ImDrawData::Clear)
    ...
    auto pyEnumImTextureFormat =
        py::enum_<ImTextureFormat>(m, "ImTextureFormat", py::arithmetic(), " We intentionally support a limited amount of texture formats to limit burden on CPU-side code and extension.\n Most standard backends only support RGBA32 but we provide a single channel option for low-resource/embedded systems.")
    ...
    auto pyEnumImTextureStatus =
        py::enum_<ImTextureStatus>(m, "ImTextureStatus", py::arithmetic(), "Status of a texture to communicate with Renderer Backend.")
    ...
    auto pyClassImTextureRect =
        ...
        .def(py::init<>()) // implicit default constructor
        .def_readwrite("x", &ImTextureRect::x, "Upper-left coordinates of rectangle to update")
        .def_readwrite("y", &ImTextureRect::y, "Upper-left coordinates of rectangle to update")
        .def_readwrite("w", &ImTextureRect::w, "Size of rectangle to update (in pixels)")
        .def_readwrite("h", &ImTextureRect::h, "Size of rectangle to update (in pixels)")
        ;


    auto pyClassImTextureData =
        py::class_<ImTextureData>
        ...
        .def_readwrite("unique_id", &ImTextureData::UniqueID, "w    -   // [DEBUG] Sequential index to facilitate identifying a texture when debugging/printing. Unique per atlas.")
        .def_readwrite("status", &ImTextureData::Status, "rw   rw  // ImTextureStatus_OK/_WantCreate/_WantUpdates/_WantDestroy. Always use SetStatus() to modify!")
        .def_readwrite("backend_user_data", &ImTextureData::BackendUserData, "-    rw  // Convenience storage for backend. Some backends may have enough with TexID.")
        .def_readwrite("tex_id", &ImTextureData::TexID, "r    w   // Backend-specific texture identifier. Always use SetTexID() to modify! The identifier will stored in ImDrawCmd::GetTexID() and passed to backend's RenderDrawData function.")
        .def_readwrite("format", &ImTextureData::Format, "w    r   // ImTextureFormat_RGBA32 (default) or ImTextureFormat_Alpha8")
        .def_readwrite("width", &ImTextureData::Width, "w    r   // Texture width")
        .def_readwrite("height", &ImTextureData::Height, "w    r   // Texture height")
        .def_readwrite("bytes_per_pixel", &ImTextureData::BytesPerPixel, "w    r   // 4 or 1")
        .def_readwrite("pixels", &ImTextureData::Pixels, "w    r   // Pointer to buffer holding 'Width*Height' pixels and 'Width*Height*BytesPerPixels' bytes.")
        .def_readwrite("used_rect", &ImTextureData::UsedRect, "w    r   // Bounding box encompassing all past and queued Updates[].")
        .def_readwrite("update_rect", &ImTextureData::UpdateRect, "w    r   // Bounding box encompassing all queued Updates[].")
        .def_readwrite("updates", &ImTextureData::Updates, "w    r   // Array of individual updates.")
        .def_readwrite("unused_frames", &ImTextureData::UnusedFrames, "w    r   // In order to facilitate handling Status==WantDestroy in some backend: this is a count successive frames where the texture was not used. Always >0 when Status==WantDestroy.")
        .def_readwrite("ref_count", &ImTextureData::RefCount, "w    r   // Number of contexts using this texture. Used during backend shutdown.")
        .def_readwrite("use_colors", &ImTextureData::UseColors, "w    r   // Tell whether our texture data is known to use colors (rather than just white + alpha).")
        .def_readwrite("want_destroy_next_frame", &ImTextureData::WantDestroyNextFrame, "rw   -   // [Internal] Queued to set ImTextureStatus_WantDestroy next frame. May still be used in the current frame.")
        .def(py::init<>(),
        ...
        .def("create",
            &ImTextureData::Create, py::arg("format"), py::arg("w"), py::arg("h"))
        .def("destroy_pixels",
    ...
    auto pyClassImFontConfig =
        ...
        .def_readwrite("font_data_owned_by_atlas", &ImFontConfig::FontDataOwnedByAtlas, "True     // TTF/OTF data ownership taken by the owner ImFontAtlas (will delete memory itself). SINCE 1.92, THE DATA NEEDS TO PERSIST FOR WHOLE DURATION OF ATLAS.")
        ...
        .def_readwrite("pixel_snap_h", &ImFontConfig::PixelSnapH, "False    // Align every glyph AdvanceX to pixel boundaries. Prevents fractional font size from working correctly! Useful e.g. if you are merging a non-pixel aligned font with the default font. If enabled, OversampleH/V will default to 1.")
        .def_readwrite("oversample_h", &ImFontConfig::OversampleH, "0 (2)    // Rasterize at higher quality for sub-pixel positioning. 0 == auto == 1 or 2 depending on size. Note the difference between 2 and 3 is minimal. You can reduce this to 1 for large glyphs save memory. Read https://github.com/nothings/stb/blob/master/tests/oversample/README.md for details.")
        .def_readwrite("oversample_v", &ImFontConfig::OversampleV, "0 (1)    // Rasterize at higher quality for sub-pixel positioning. 0 == auto == 1. This is not really useful as we don't use sub-pixel positions on the Y axis.")
        .def_readwrite("ellipsis_char", &ImFontConfig::EllipsisChar, "0        // Explicitly specify Unicode codepoint of ellipsis character. When fonts are being merged first specified ellipsis will be used.")
        .def_readwrite("size_pixels", &ImFontConfig::SizePixels, "// Output size in pixels for rasterizer (more or less maps to the resulting font height).")
        .def_readwrite("glyph_offset", &ImFontConfig::GlyphOffset, "0, 0     // Offset (in pixels) all glyphs from this font input. Absolute value for default size, other sizes will scale this value.")
        .def_readwrite("glyph_min_advance_x", &ImFontConfig::GlyphMinAdvanceX, "0        // Minimum AdvanceX for glyphs, set Min to align font icons, set both Min/Max to enforce mono-space font. Absolute value for default size, other sizes will scale this value.")
        .def_readwrite("glyph_max_advance_x", &ImFontConfig::GlyphMaxAdvanceX, "FLT_MAX  // Maximum AdvanceX for glyphs")
        .def_readwrite("glyph_extra_advance_x", &ImFontConfig::GlyphExtraAdvanceX, "0        // Extra spacing (in pixels) between glyphs. Please contact us if you are using this. // FIXME-NEWATLAS: Intentionally unscaled")
        .def_readwrite("font_no", &ImFontConfig::FontNo, "0        // Index of font within TTF/OTF file")
        .def_readwrite("font_loader_flags", &ImFontConfig::FontLoaderFlags, "0        // Settings for custom font builder. THIS IS BUILDER IMPLEMENTATION DEPENDENT. Leave as zero if unsure.")
        ...
        .def_readwrite("extra_size_scale", &ImFontConfig::ExtraSizeScale, "1.0     // Extra rasterizer scale over SizePixels.")
        .def_readwrite("flags", &ImFontConfig::Flags, "Font flags (don't use just yet, will be exposed in upcoming 1.92.X updates)")
        .def_readwrite("dst_font", &ImFontConfig::DstFont, "Target font (as we merging fonts, multiple ImFontConfig may target the same font)")
        .def_readwrite("font_loader_data", &ImFontConfig::FontLoaderData, "Font loader opaque storage (per font config)")
        .def(py::init<>())
        ;
    ...
    auto pyClassImFontGlyph =
        ...
        .def_readwrite("advance_x", &ImFontGlyph::AdvanceX, "Horizontal distance to advance cursor/layout position.")
        .def_readwrite("x0", &ImFontGlyph::X0, "Glyph corners. Offsets from current cursor/layout position.")
        .def_readwrite("y0", &ImFontGlyph::Y0, "Glyph corners. Offsets from current cursor/layout position.")
        .def_readwrite("x1", &ImFontGlyph::X1, "Glyph corners. Offsets from current cursor/layout position.")
        .def_readwrite("y1", &ImFontGlyph::Y1, "Glyph corners. Offsets from current cursor/layout position.")
        .def_readwrite("u0", &ImFontGlyph::U0, "Texture coordinates for the current value of ImFontAtlas->TexRef. Cached equivalent of calling GetCustomRect() with PackId.")
        .def_readwrite("v0", &ImFontGlyph::V0, "Texture coordinates for the current value of ImFontAtlas->TexRef. Cached equivalent of calling GetCustomRect() with PackId.")
        .def_readwrite("u1", &ImFontGlyph::U1, "Texture coordinates for the current value of ImFontAtlas->TexRef. Cached equivalent of calling GetCustomRect() with PackId.")
        .def_readwrite("v1", &ImFontGlyph::V1, "Texture coordinates for the current value of ImFontAtlas->TexRef. Cached equivalent of calling GetCustomRect() with PackId.")
        .def_readwrite("pack_id", &ImFontGlyph::PackId, "[Internal] ImFontAtlasRectId value (FIXME: Cold data, could be moved elsewhere?)")
        .def(py::init<>())
        // #ifdef IMGUI_BUNDLE_PYTHON_API
        //
        .def("is_colored",
    ...
    auto pyClassImFontAtlasRect =
        ...
        .def_readwrite("x", &ImFontAtlasRect::x, "Position (in current texture)")
        .def_readwrite("y", &ImFontAtlasRect::y, "Position (in current texture)")
        .def_readwrite("w", &ImFontAtlasRect::w, "Size")
        .def_readwrite("h", &ImFontAtlasRect::h, "Size")
        .def_readwrite("uv0", &ImFontAtlasRect::uv0, "UV coordinates (in current texture)")
        .def_readwrite("uv1", &ImFontAtlasRect::uv1, "UV coordinates (in current texture)")
        .def(py::init<>())
        ;
    ...
    auto pyClassImFontAtlas =
        ...
        .def("add_font_default_bitmap",
            ...
            py::return_value_policy::reference)
        .def("remove_font",
            &ImFontAtlas::RemoveFont, py::arg("font"))
        .def("clear",
        ...
        .def("add_font_from_file_ttf",
            ...
            py::arg("filename"), py::arg("size_pixels"), py::arg("font_cfg") = py::none(),
            py::return_value_policy::reference)
        // #endif
        //
        .def("add_custom_rect",
            &ImFontAtlas::AddCustomRect,
            py::arg("width"), py::arg("height"), py::arg("out_r") = py::none(),
        ...
        .def_readwrite("tex_desired_format", &ImFontAtlas::TexDesiredFormat, "Desired texture format (default to ImTextureFormat_RGBA32 but may be changed to ImTextureFormat_Alpha8).")
        .def_readwrite("tex_glyph_padding", &ImFontAtlas::TexGlyphPadding, "FIXME: Should be called \"TexPackPadding\". Padding between glyphs within texture in pixels. Defaults to 1. If your rendering method doesn't rely on bilinear filtering you may set this to 0 (will also need to set AntiAliasedLinesUseTex = False).")
        .def_readwrite("tex_min_width", &ImFontAtlas::TexMinWidth, "Minimum desired texture width. Must be a power of two. Default to 512.")
        .def_readwrite("tex_min_height", &ImFontAtlas::TexMinHeight, "Minimum desired texture height. Must be a power of two. Default to 128.")
        .def_readwrite("tex_max_width", &ImFontAtlas::TexMaxWidth, "Maximum desired texture width. Must be a power of two. Default to 8192.")
        .def_readwrite("tex_max_height", &ImFontAtlas::TexMaxHeight, "Maximum desired texture height. Must be a power of two. Default to 8192.")
        .def_readwrite("user_data", &ImFontAtlas::UserData, "Store your own atlas related user-data (if e.g. you have multiple font atlas).")
        .def_readwrite("tex_data", &ImFontAtlas::TexData, "Latest texture.")
        // #ifdef IMGUI_BUNDLE_PYTHON_API
        //
        ...
        // #endif
        //
        .def_readwrite("tex_list", &ImFontAtlas::TexList, "Texture list (most often TexList.Size == 1). TexData is always == TexList.back(). DO NOT USE DIRECTLY, USE GetDrawData().Textures[]/GetPlatformIO().Textures[] instead!")
        .def_readwrite("locked", &ImFontAtlas::Locked, "Marked as locked during ImGui::NewFrame()..EndFrame() scope if TexUpdates are not supported. Any attempt to modify the atlas will assert.")
        .def_readwrite("renderer_has_textures", &ImFontAtlas::RendererHasTextures, "Copy of (BackendFlags & ImGuiBackendFlags_RendererHasTextures) from supporting context.")
        .def_readwrite("tex_is_built", &ImFontAtlas::TexIsBuilt, "Set when texture was built matching current font input. Mostly useful for legacy IsBuilt() call.")
        .def_readwrite("tex_pixels_use_colors", &ImFontAtlas::TexPixelsUseColors, "Tell whether our texture data is known to use colors (rather than just alpha channel), in order to help backend select a format or conversion process.")
        .def_readwrite("tex_uv_scale", &ImFontAtlas::TexUvScale, "= (1.0/TexData->TexWidth, 1.0/TexData->TexHeight). May change as new texture gets created.")
        .def_readwrite("tex_uv_white_pixel", &ImFontAtlas::TexUvWhitePixel, "Texture coordinates to a white pixel. May change as new texture gets created.")
        ...
        .def_readwrite("sources", &ImFontAtlas::Sources, "Source/configuration data")
        .def_readwrite("tex_next_unique_id", &ImFontAtlas::TexNextUniqueID, "Next value to be stored in TexData->UniqueID")
        .def_readwrite("font_next_unique_id", &ImFontAtlas::FontNextUniqueID, "Next value to be stored in ImFont->FontID")
        .def_readonly("font_loader_name", &ImFontAtlas::FontLoaderName, "Font loader name (for display e.g. in About box) == FontLoader->Name")
        .def_readwrite("font_loader_data", &ImFontAtlas::FontLoaderData, "Font backend opaque storage")
        .def_readwrite("font_loader_flags", &ImFontAtlas::FontLoaderFlags, "Shared flags (for all fonts) for font loader. THIS IS BUILD IMPLEMENTATION DEPENDENT (e.g. Per-font override is also available in ImFontConfig).")
        .def_readwrite("ref_count", &ImFontAtlas::RefCount, "Number of contexts using this atlas")
        .def_readwrite("owner_context", &ImFontAtlas::OwnerContext, "Context which own the atlas will be in charge of updating and destroying it.")
        ;


    auto pyClassImFontBaked =
        py::class_<ImFontBaked>
            (m, "ImFontBaked", " Font runtime data for a given size\n Important: pointers to ImFontBaked are only valid for the current frame.")
        .def_readwrite("index_advance_x", &ImFontBaked::IndexAdvanceX, "12-16 // out // Sparse. Glyphs->AdvanceX in a directly indexable way (cache-friendly for CalcTextSize functions which only this info, and are often bottleneck in large UI).")
        .def_readwrite("fallback_advance_x", &ImFontBaked::FallbackAdvanceX, "4     // out // FindGlyph(FallbackChar)->AdvanceX")
        .def_readwrite("size", &ImFontBaked::Size, "4     // in  // Height of characters/line, set during loading (doesn't change after loading)")
        .def_readwrite("rasterizer_density", &ImFontBaked::RasterizerDensity, "4     // in  // Density this is baked at")
        .def_readwrite("index_lookup", &ImFontBaked::IndexLookup, "12-16 // out // Sparse. Index glyphs by Unicode code-point.")
        .def_readwrite("glyphs", &ImFontBaked::Glyphs, "12-16 // out // All glyphs.")
        .def_readwrite("fallback_glyph_index", &ImFontBaked::FallbackGlyphIndex, "4     // out // Index of FontFallbackChar")
        .def_readwrite("ascent", &ImFontBaked::Ascent, "4+4   // out // Ascent: distance from top to bottom of e.g. 'A' [0..FontSize] (unscaled)")
        .def_readwrite("descent", &ImFontBaked::Descent, "4+4   // out // Ascent: distance from top to bottom of e.g. 'A' [0..FontSize] (unscaled)")
        .def_readwrite("last_used_frame", &ImFontBaked::LastUsedFrame, "4  //     // Record of that time this was bounds")
        .def_readwrite("baked_id", &ImFontBaked::BakedId, "4     //     // Unique ID for this baked storage")
        .def_readwrite("owner_font", &ImFontBaked::OwnerFont, "4-8   // in  // Parent font")
        .def_readwrite("font_loader_datas", &ImFontBaked::FontLoaderDatas, "4-8   //     // Font loader opaque storage (per baked font * sources): single contiguous buffer allocated by imgui, passed to loader.")
        .def(py::init<>())
    ...
    auto pyClassImFont =
        ...
        .def_readwrite("last_baked", &ImFont::LastBaked, "4-8   // Cache last bound baked. NEVER USE DIRECTLY. Use GetFontBaked().")
        .def_readwrite("owner_atlas", &ImFont::OwnerAtlas, "4-8   // What we have been loaded into.")
        .def_readwrite("flags", &ImFont::Flags, "4     // Font flags.")
        .def_readwrite("current_rasterizer_density", &ImFont::CurrentRasterizerDensity, "Current rasterizer density. This is a varying state of the font.")
        .def_readwrite("font_id", &ImFont::FontId, "Unique identifier for the font")
        .def_readwrite("legacy_size", &ImFont::LegacySize, "4     // in  // Font size passed to AddFont(). Use for old code calling PushFont() expecting to use that size. (use ImGui::GetFontBaked() to get font baked at current bound size).")
        .def_readwrite("sources", &ImFont::Sources, "16    // in  // List of sources. Pointers within OwnerAtlas->Sources[]")
        .def_readwrite("ellipsis_char", &ImFont::EllipsisChar, "2-4   // out // Character used for ellipsis rendering ('...'). If you ever want to temporarily swap this for an alternative/dummy char, make sure to clear EllipsisAutoBake.")
        .def_readwrite("fallback_char", &ImFont::FallbackChar, "2-4   // out // Character used if a glyph isn't found (U+FFFD, '?')")
        .def_readwrite("ellipsis_auto_bake", &ImFont::EllipsisAutoBake, "1     //     // Mark when the \"...\" glyph (== EllipsisChar) needs to be generated by combining multiple '.'.")
        .def_readwrite("remap_pairs", &ImFont::RemapPairs, "16    //     // Remapping pairs when using AddRemapChar(), otherwise empty.")
        .def(py::init<>(),
            "Methods")
        .def("is_glyph_in_font",
            &ImFont::IsGlyphInFont, py::arg("c"))
        .def("is_loaded",
        ...
        .def("get_font_baked",
            &ImFont::GetFontBaked,
            py::arg("font_size"), py::arg("density") = -1.0f,
        ...
        .def("calc_word_wrap_position_python",
            ...
            py::arg("size"), py::arg("text"), py::arg("wrap_width"),
            "Python API for CalcWordWrapPosition (will return an index in the text, not a pointer)")
        // #endif
        //
        .def("render_char",
            &ImFont::RenderChar, py::arg("draw_list"), py::arg("size"), py::arg("pos"), py::arg("col"), py::arg("c"), py::arg("cpu_fine_clip") = py::none())
        .def("render_text",
            &ImFont::RenderText, py::arg("draw_list"), py::arg("size"), py::arg("pos"), py::arg("col"), py::arg("clip_rect"), py::arg("text_begin"), py::arg("text_end"), py::arg("wrap_width") = 0.0f, py::arg("flags") = 0)
        .def("clear_output_data",
            &ImFont::ClearOutputData)
        .def("add_remap_char",
            &ImFont::AddRemapChar,
            py::arg("from_codepoint"), py::arg("to_codepoint"),
    ...
    auto pyClassImGuiViewport =
        ...
        .def_readwrite("framebuffer_scale", &ImGuiViewport::FramebufferScale, "Density of the viewport for Retina display (always 1,1 on Windows, may be 2,2 etc on macOS/iOS). This will affect font rasterizer density.")
        ...
        .def_readwrite("parent_viewport", &ImGuiViewport::ParentViewport, "(Advanced) Direct shortcut to ImGui::FindViewportByID(ParentViewportId). None: no parent.")
        ...
        .def_readwrite("platform_icon_data", &ImGuiViewport::PlatformIconData, "None* to hold custom data structure for the OS / platform to specify an icon. Currently unused for exposed to allow experiments.")
        .def_readwrite("platform_handle", &ImGuiViewport::PlatformHandle, "None* to hold higher-level, platform window handle (e.g. HWND for Win32 backend, Uint32 WindowID for SDL, GLFWWindow* for GLFW), for FindViewportByPlatformHandle().")
        .def_readwrite("platform_handle_raw", &ImGuiViewport::PlatformHandleRaw, "None* to hold lower-level, platform-native window handle (always HWND on Win32 platform, unused for other platforms).")
        ...
        .def("get_debug_name",
            &ImGuiViewport::GetDebugName, py::return_value_policy::reference)
        ;
    ...
    auto pyClassImGuiPlatformIO =
        ...
        .def_readwrite("renderer_texture_max_width", &ImGuiPlatformIO::Renderer_TextureMaxWidth, "")
        .def_readwrite("renderer_texture_max_height", &ImGuiPlatformIO::Renderer_TextureMaxHeight, "")
        ...
        .def_readwrite("textures", &ImGuiPlatformIO::Textures, "List of textures used by Dear ImGui (most often 1) + contents of external texture list is automatically appended into this.")
    ...
    auto pyClassImGuiPlatformImeData =
        ...
        .def_readwrite("want_text_input", &ImGuiPlatformImeData::WantTextInput, "A widget wants text input, not necessarily IME to be visible. This is automatically set to the upcoming value of io.WantTextInput.")
        .def_readwrite("input_pos", &ImGuiPlatformImeData::InputPos, "Position of input cursor (for IME).")
        .def_readwrite("input_line_height", &ImGuiPlatformImeData::InputLineHeight, "Line height (for IME).")
        .def_readwrite("viewport_id", &ImGuiPlatformImeData::ViewportId, "ID of platform window/viewport.")
        .def(py::init<>())
        ;
    ...
    m.def("begin_horizontal",
        ...
        py::arg("str_id"), py::arg("size").none() = py::none(), py::arg("align") = -1.0f,
        "Python bindings defaults:\n    If size is None, then its default value will be: ImVec2(0, 0)");
    ...
    m.def("begin_horizontal",
        ...
        py::arg("ptr_id"), py::arg("size").none() = py::none(), py::arg("align") = -1.0f,
        "Python bindings defaults:\n    If size is None, then its default value will be: ImVec2(0, 0)");
    ...
    m.def("begin_horizontal",
        ...
        py::arg("id_"), py::arg("size").none() = py::none(), py::arg("align") = -1,
        "Python bindings defaults:\n    If size is None, then its default value will be: ImVec2(0, 0)");
    ...
    m.def("input_text_multiline",
        ...
        py::arg("label"), py::arg("str"), py::arg("size").none() = py::none(), py::arg("flags") = 0, py::arg("callback") = py::none(), py::arg("user_data") = py::none(),
        "Python bindings defaults:\n    If size is None, then its default value will be: ImVec2(0, 0)");
    ...
    auto pyClassImGuiPayload_PyId =
        ...
        py::arg("data_id").none() = py::none(), py::arg("type") = std::string()
        )
...
void imgui_manual_binding(py::module_& m)
{
    ...
    py::class_<ImVec2>& pyClassImVec2  = *pyClassImVec2Ptr;
    py::class_<ImVec4>& pyClassImVec4 = *pyClassImVec4Ptr;
    py::class_<ImColor>& pyClassImColor = *pyClassImColorPtr;

    // these are internal functions that should only be called with a tuple, list or array argument
    auto cast_to_imvec2 = [](py::handle obj) -> ImVec2
    {
        if (len(obj) != 2)
            throw std::invalid_argument("Python tuple/list/array to imgui.ImVec2: size should be 2!");
        auto floats = py::cast<std::vector<float>>(obj);
        return ImVec2(floats[0], floats[1]);
    };
    auto cast_to_imvec4 = [](py::handle obj) -> ImVec4
    {
        if (len(obj) != 4)
    ...
    auto cast_to_imcolor = [](py::handle obj) -> ImColor
    {
    ...
    pyClassImVec2.def("__init__", [&cast_to_imvec2](ImVec2 *self, py::tuple t) {
        new (self) ImVec2();
        *self = cast_to_imvec2(t);
    });
    pyClassImVec2.def("__init__", [&cast_to_imvec2](ImVec2 *self, py::list l) {
        new (self) ImVec2();
        *self = cast_to_imvec2(l);
    });
//    pyClassImVec2.def("__init__", [](ImVec2 *self, py::array a) {
//        new (self) ImVec2();
...
//    });
    ...
    pyClassImVec2.def("__setstate__", [](ImVec2 &self, py::tuple t) {
        new(&self) ImVec2();
        if (t.size() != 2)
            throw std::runtime_error("ImVec2 unpickling failed");
        ImVec2 r(py::cast<float>(t[0]), py::cast<float>(t[1]));
        self = r;
    });
    ...
    pyClassImVec4.def("__init__", [&cast_to_imvec4](ImVec4 *self, py::tuple t) {
        new (self) ImVec4();
        *self = cast_to_imvec4(t);
    });
    pyClassImVec4.def("__init__", [&cast_to_imvec4](ImVec4 *self, py::list l) {
        new (self) ImVec4();
        *self = cast_to_imvec4(l);
    });
//    pyClassImVec4.def("__init__", [](ImVec4 *self, py::array a) {
//        new (self) ImVec4();
...
//    });
    ...
    pyClassImVec4.def("__setstate__", [](ImVec4 &self, py::tuple t) {
        new(&self) ImVec2();
        if (t.size() != 4)
            throw std::runtime_error("ImVec4 unpickling failed");
        ImVec4 r(py::cast<float>(t[0]), py::cast<float>(t[1]), py::cast<float>(t[2]), py::cast<float>(t[3]));
        self = r;
    });
    ...
    pyClassImColor.def("__init__", [&cast_to_imcolor](ImColor *self, py::tuple t) {
        new (self) ImColor();
        *self = cast_to_imcolor(t);
    });
    pyClassImColor.def("__init__", [&cast_to_imcolor](ImColor *self, py::list l) {
        new (self) ImColor();
        *self = cast_to_imcolor(l);
    });
//    pyClassImColor.def("__init__", [](ImColor *self, py::array a) {
//        new (self) ImColor();
...
//    });
    ...
    pyClassImColor.def("__setstate__", [](ImColor &self, py::tuple t) {
        new(&self) ImColor();
        if (t.size() != 4)
            throw std::runtime_error("ImVec4 unpickling failed");
        ImVec4 r(py::cast<float>(t[0]), py::cast<float>(t[1]), py::cast<float>(t[2]), py::cast<float>(t[3]));
