...
#include "imgui.h"
#include "implot.h" // BIBBY-CHANGE - Relocated.
#include "implot_internal.h" // BIBBY-CHANGE - Relocated.


namespace py = pybind11;


static char pybind11_array_type_to_letter_code(const py::array& array)
{
    const char kind = array.dtype().kind();
    const size_t item_size = static_cast<size_t>(array.itemsize());

    if (kind == 'u') {
        if (item_size == 1) return 'B';
        if (item_size == 2) return 'H';
        if (item_size == 4) return 'I';
        if (item_size == 8) return 'L';
    } else if (kind == 'i') {
        if (item_size == 1) return 'b';
        if (item_size == 2) return 'h';
        if (item_size == 4) return 'i';
        ...
        if (item_size == 4) return 'f';
        if (item_size == 8) return 'd';
        if (item_size == 16) return 'g';
    }

    throw std::runtime_error("Unsupported dtype");
}

static bool pybind11_array_is_uint32(const py::array& array)
{
    return array.dtype().kind() == 'u' && static_cast<size_t>(array.itemsize()) == sizeof(uint32_t);
}

static bool pybind11_array_is_float32(const py::array& array)
{
    return array.dtype().kind() == 'f' && static_cast<size_t>(array.itemsize()) == sizeof(float);
}


py::class_<ImPlotPoint>* pyClassImPlotPointPtr  = nullptr;


void implot_binding_manual(py::module_& m);
...
void py_init_module_implot(py::module_& m)
{
    ...
    auto pyEnumProp_ =
        py::enum_<ImPlotProp_>(m, "Prop_", py::arithmetic(), "Plotting properties. These provide syntactic sugar for creating ImPlotSpecs from (ImPlotProp,value) pairs. See ImPlotSpec documentation.")
    ...
    auto pyEnumItemFlags_ =
        py::enum_<ImPlotItemFlags_>(m, "ItemFlags_", py::arithmetic(), "Flags for ANY PlotX function. Used by setting ImPlotSpec::Flags.")
    ...
    auto pyEnumLineFlags_ =
        py::enum_<ImPlotLineFlags_>(m, "LineFlags_", py::arithmetic(), "Flags for PlotLine. Used by setting ImPlotSpec::Flags.")
    ...
    auto pyEnumScatterFlags_ =
        py::enum_<ImPlotScatterFlags_>(m, "ScatterFlags_", py::arithmetic(), "Flags for PlotScatter. Used by setting ImPlotSpec::Flags.")
    ...
    auto pyEnumBubblesFlags_ =
        py::enum_<ImPlotBubblesFlags_>(m, "BubblesFlags_", py::arithmetic(), "Flags for PlotBubbles. Used by setting ImPlotSpec::Flags.")
            .value("none", ImPlotBubblesFlags_None, "default");


    auto pyEnumPolygonFlags_ =
        py::enum_<ImPlotPolygonFlags_>(m, "PolygonFlags_", py::arithmetic(), "Flags for PlotPolygon. Used by setting ImPlotSpec::Flags.")
    ...
    auto pyEnumStairsFlags_ =
        py::enum_<ImPlotStairsFlags_>(m, "StairsFlags_", py::arithmetic(), "Flags for PlotStairs. Used by setting ImPlotSpec::Flags.")
    ...
    auto pyEnumShadedFlags_ =
        py::enum_<ImPlotShadedFlags_>(m, "ShadedFlags_", py::arithmetic(), "Flags for PlotShaded (placeholder). Used by setting ImPlotSpec::Flags.")
            .value("none", ImPlotShadedFlags_None, "default");


    auto pyEnumBarsFlags_ =
        py::enum_<ImPlotBarsFlags_>(m, "BarsFlags_", py::arithmetic(), "Flags for PlotBars. Used by setting ImPlotSpec::Flags.")
    ...
    auto pyEnumBarGroupsFlags_ =
        py::enum_<ImPlotBarGroupsFlags_>(m, "BarGroupsFlags_", py::arithmetic(), "Flags for PlotBarGroups. Used by setting ImPlotSpec::Flags.")
    ...
    auto pyEnumErrorBarsFlags_ =
        py::enum_<ImPlotErrorBarsFlags_>(m, "ErrorBarsFlags_", py::arithmetic(), "Flags for PlotErrorBars. Used by setting ImPlotSpec::Flags.")
    ...
    auto pyEnumStemsFlags_ =
        py::enum_<ImPlotStemsFlags_>(m, "StemsFlags_", py::arithmetic(), "Flags for PlotStems. Used by setting ImPlotSpec::Flags.")
    ...
    auto pyEnumInfLinesFlags_ =
        py::enum_<ImPlotInfLinesFlags_>(m, "InfLinesFlags_", py::arithmetic(), "Flags for PlotInfLines. Used by setting ImPlotSpec::Flags.")
    ...
    auto pyEnumPieChartFlags_ =
        py::enum_<ImPlotPieChartFlags_>(m, "PieChartFlags_", py::arithmetic(), "Flags for PlotPieChart. Used by setting ImPlotSpec::Flags.")
    ...
    auto pyEnumHeatmapFlags_ =
        py::enum_<ImPlotHeatmapFlags_>(m, "HeatmapFlags_", py::arithmetic(), "Flags for PlotHeatmap. Used by setting ImPlotSpec::Flags.")
    ...
    auto pyEnumHistogramFlags_ =
        py::enum_<ImPlotHistogramFlags_>(m, "HistogramFlags_", py::arithmetic(), "Flags for PlotHistogram and PlotHistogram2D. Used by setting ImPlotSpec::Flags.")
    ...
    auto pyEnumDigitalFlags_ =
        py::enum_<ImPlotDigitalFlags_>(m, "DigitalFlags_", py::arithmetic(), "Flags for PlotDigital (placeholder). Used by setting ImPlotSpec::Flags.")
            .value("none", ImPlotDigitalFlags_None, "default");


    auto pyEnumImageFlags_ =
        py::enum_<ImPlotImageFlags_>(m, "ImageFlags_", py::arithmetic(), "Flags for PlotImage (placeholder). Used by setting ImPlotSpec::Flags.")
            .value("none", ImPlotImageFlags_None, "default");


    auto pyEnumTextFlags_ =
        py::enum_<ImPlotTextFlags_>(m, "TextFlags_", py::arithmetic(), "Flags for PlotText. Used by setting ImPlotSpec::Flags.")
    ...
    auto pyEnumDummyFlags_ =
        py::enum_<ImPlotDummyFlags_>(m, "DummyFlags_", py::arithmetic(), "Flags for PlotDummy (placeholder). Used by setting ImPlotSpec::Flags.")
    ...
    auto pyClassImPlotSpec =
        ...
        py::arg("line_color").none() = py::none(), py::arg("line_weight") = 1.0f, py::arg("fill_color").none() = py::none(), py::arg("fill_alpha") = 1.0f, py::arg("marker").none() = py::none(), py::arg("marker_size") = 4, py::arg("marker_line_color").none() = py::none(), py::arg("marker_fill_color").none() = py::none(), py::arg("size") = 4, py::arg("offset") = 0, py::arg("stride") = IMPLOT_AUTO, py::arg("flags") = ImPlotItemFlags_None
        )
        .def_readwrite("line_color", &ImPlotSpec::LineColor, "line color (applies to lines, bar edges); IMPLOT_AUTO_COL will use next Colormap color or current item color")
        .def_readwrite("line_weight", &ImPlotSpec::LineWeight, "line weight in pixels (applies to lines, bar edges, marker edges)")
        .def_readwrite("fill_color", &ImPlotSpec::FillColor, "fill color (applies to shaded regions, bar faces); IMPLOT_AUTO_COL will use next Colormap color or current item color")
        .def_readwrite("fill_alpha", &ImPlotSpec::FillAlpha, "alpha multiplier (applies to FillColor, FillColors, MarkerFillColor, and MarkerFillColors)")
        .def_readwrite("marker", &ImPlotSpec::Marker, "marker type; specify ImPlotMarker_Auto to use the next unused marker")
        .def_readwrite("marker_size", &ImPlotSpec::MarkerSize, "size of markers (radius) *in pixels*")
        .def_readwrite("marker_line_color", &ImPlotSpec::MarkerLineColor, "marker edge color; IMPLOT_AUTO_COL will use LineColor")
        .def_readwrite("marker_fill_color", &ImPlotSpec::MarkerFillColor, "marker face color; IMPLOT_AUTO_COL will use LineColor")
        .def_readwrite("size", &ImPlotSpec::Size, "size of error bar whiskers (width or height), and digital bars (height) *in pixels*")
        .def_readwrite("offset", &ImPlotSpec::Offset, "data index offset")
        .def_readwrite("stride", &ImPlotSpec::Stride, "data stride in bytes; IMPLOT_AUTO will result in sizeof(T) where T is the type passed to PlotX")
        .def_readwrite("flags", &ImPlotSpec::Flags, "optional item flags; can be composed from common ImPlotItemFlags and/or specialized ImPlotXFlags")
        ;

    pyClassImPlotSpec.def_property("line_colors",
        [](ImPlotSpec& self) -> uintptr_t { return reinterpret_cast<uintptr_t>(self.LineColors); },
        [](ImPlotSpec& self, py::array& arr) {
            if (!pybind11_array_is_uint32(arr))
                throw py::type_error("line_colors requires a np.uint32 array");
    ...
    pyClassImPlotSpec.def_property("fill_colors",
        [](ImPlotSpec& self) -> uintptr_t { return reinterpret_cast<uintptr_t>(self.FillColors); },
        [](ImPlotSpec& self, py::array& arr) {
            if (!pybind11_array_is_uint32(arr))
                throw py::type_error("fill_colors requires a np.uint32 array");
    ...
    pyClassImPlotSpec.def_property("marker_line_colors",
        [](ImPlotSpec& self) -> uintptr_t { return reinterpret_cast<uintptr_t>(self.MarkerLineColors); },
        [](ImPlotSpec& self, py::array& arr) {
            if (!pybind11_array_is_uint32(arr))
                throw py::type_error("marker_line_colors requires a np.uint32 array");
    ...
    pyClassImPlotSpec.def_property("marker_fill_colors",
        [](ImPlotSpec& self) -> uintptr_t { return reinterpret_cast<uintptr_t>(self.MarkerFillColors); },
        [](ImPlotSpec& self, py::array& arr) {
            if (!pybind11_array_is_uint32(arr))
                throw py::type_error("marker_fill_colors requires a np.uint32 array");
    ...
    pyClassImPlotSpec.def_property("marker_sizes",
        [](ImPlotSpec& self) -> uintptr_t { return reinterpret_cast<uintptr_t>(self.MarkerSizes); },
        [](ImPlotSpec& self, py::array& arr) {
            if (!pybind11_array_is_float32(arr))
                throw py::type_error("marker_sizes requires a np.float32 array");
    ...
    auto pyClassImPlotPoint =
        ...
        .def("__getitem__",
            py::overload_cast<size_t>(&ImPlotPoint::operator[], py::const_), py::arg("idx"))
        ;
    ...
    auto pyClassImPlotRect =
        ...
        .def("size",
            &ImPlotRect::Size)
        .def("clamp",
            py::overload_cast<const ImPlotPoint &>(&ImPlotRect::Clamp, py::const_), py::arg("p"))
        .def("clamp",
            py::overload_cast<double, double>(&ImPlotRect::Clamp, py::const_), py::arg("x"), py::arg("y"))
        .def("min",
            &ImPlotRect::Min)
        .def("max",
            &ImPlotRect::Max)
    ...
    auto pyClassImPlotStyle =
        ...
        .def_readwrite("digital_padding", &ImPlotStyle::DigitalPadding, "= 20,     digital plot padding from bottom in pixels")
        .def_readwrite("digital_spacing", &ImPlotStyle::DigitalSpacing, "= 4,      digital plot spacing gap in pixels")
        // #ifdef IMGUI_BUNDLE_PYTHON_API
        //
        .def("color_",
            &ImPlotStyle::Color_,
    ...
    m.def("begin_plot",
        ...
        py::arg("title_id"), py::arg("size").none() = py::none(), py::arg("flags") = 0,
    ...
    auto pyClassSubplotsRowColRatios =
        ...
        py::arg("row_ratios").none() = py::none(), py::arg("col_ratios").none() = py::none()
        )
    ...
    m.def("setup_axis",
        ...
        py::arg("axis"), py::arg("label").none() = py::none(), py::arg("flags") = 0,
    ...
    m.def("setup_axis_limits",
        ...
        py::arg("axis"), py::arg("v_min"), py::arg("v_max"), py::arg("cond").none() = py::none(),
    ...
    m.def("setup_axes_limits",
        ...
        py::arg("x_min"), py::arg("x_max"), py::arg("y_min"), py::arg("y_max"), py::arg("cond").none() = py::none(),
    ...
    m.def("plot_line",
        [](const char * label_id, py::array & values, double xscale = 1, double xstart = 0, const std::optional<const ImPlotSpec> & spec = std::nullopt)
        {
            auto PlotLine_adapt_c_buffers = [](const char * label_id, py::array & values, double xscale = 1, double xstart = 0, const ImPlotSpec & spec = ImPlotSpec())
            {
                ...
                char values_type = pybind11_array_type_to_letter_code(values);
            ...
            auto PlotLine_adapt_mutable_param_with_default_value = [&PlotLine_adapt_c_buffers](const char * label_id, py::array & values, double xscale = 1, double xstart = 0, const std::optional<const ImPlotSpec> & spec = std::nullopt)
            {
        ...
        py::arg("label_id"), py::arg("values"), py::arg("xscale") = 1, py::arg("xstart") = 0, py::arg("spec").none() = py::none(),
        "Python bindings defaults:\n    If spec is None, then its default value will be: Spec()");

    m.def("plot_line",
        [](const char * label_id, py::array & xs, py::array & ys, const std::optional<const ImPlotSpec> & spec = std::nullopt)
        {
            auto PlotLine_adapt_c_buffers = [](const char * label_id, py::array & xs, py::array & ys, const ImPlotSpec & spec = ImPlotSpec())
            {
                // Check if the array is 1D and C-contiguous
                ...
                // Compute the letter code for the buffer type
                char ys_type = pybind11_array_type_to_letter_code(ys);
            ...
            auto PlotLine_adapt_mutable_param_with_default_value = [&PlotLine_adapt_c_buffers](const char * label_id, py::array & xs, py::array & ys, const std::optional<const ImPlotSpec> & spec = std::nullopt)
            {
        ...
        py::arg("label_id"), py::arg("xs"), py::arg("ys"), py::arg("spec").none() = py::none(),
        "Python bindings defaults:\n    If spec is None, then its default value will be: Spec()");

    m.def("plot_scatter",
        [](const char * label_id, py::array & values, double xscale = 1, double xstart = 0, const std::optional<const ImPlotSpec> & spec = std::nullopt)
        {
            auto PlotScatter_adapt_c_buffers = [](const char * label_id, py::array & values, double xscale = 1, double xstart = 0, const ImPlotSpec & spec = ImPlotSpec())
            {
                // Check if the array is 1D and C-contiguous
                if (! (values.ndim() == 1 && values.strides(0) == values.itemsize()))
                    throw std::runtime_error("The array must be 1D and contiguous");
            ...
            auto PlotScatter_adapt_mutable_param_with_default_value = [&PlotScatter_adapt_c_buffers](const char * label_id, py::array & values, double xscale = 1, double xstart = 0, const std::optional<const ImPlotSpec> & spec = std::nullopt)
            {
    ...
    m.def("plot_scatter",
        [](const char * label_id, py::array & xs, py::array & ys, const std::optional<const ImPlotSpec> & spec = std::nullopt)
        {
            auto PlotScatter_adapt_c_buffers = [](const char * label_id, py::array & xs, py::array & ys, const ImPlotSpec & spec = ImPlotSpec())
            {
                // Check if the array is 1D and C-contiguous
                if (! (xs.ndim() == 1 && xs.strides(0) == xs.itemsize()))
                    throw std::runtime_error("The array must be 1D and contiguous");
            ...
            auto PlotScatter_adapt_mutable_param_with_default_value = [&PlotScatter_adapt_c_buffers](const char * label_id, py::array & xs, py::array & ys, const std::optional<const ImPlotSpec> & spec = std::nullopt)
            {
    ...
    m.def("plot_bubbles",
        [](const char * label_id, py::array & values, py::array & szs, double xscale = 1, double xstart = 0, const std::optional<const ImPlotSpec> & spec = std::nullopt)
        {
            auto PlotBubbles_adapt_c_buffers = [](const char * label_id, py::array & values, py::array & szs, double xscale = 1, double xstart = 0, const ImPlotSpec & spec = ImPlotSpec())
            {
                // Check if the array is 1D and C-contiguous
                if (! (values.ndim() == 1 && values.strides(0) == values.itemsize()))
                    throw std::runtime_error("The array must be 1D and contiguous");
                ...
                // Check if the array is 1D and C-contiguous
                if (! (szs.ndim() == 1 && szs.strides(0) == szs.itemsize()))
                    throw std::runtime_error("The array must be 1D and contiguous");
                ...
                // Compute the letter code for the buffer type
                char szs_type = pybind11_array_type_to_letter_code(szs);
            ...
            auto PlotBubbles_adapt_mutable_param_with_default_value = [&PlotBubbles_adapt_c_buffers](const char * label_id, py::array & values, py::array & szs, double xscale = 1, double xstart = 0, const std::optional<const ImPlotSpec> & spec = std::nullopt)
            {
        ...
        py::arg("label_id"), py::arg("values"), py::arg("szs"), py::arg("xscale") = 1, py::arg("xstart") = 0, py::arg("spec").none() = py::none(),
        "Python bindings defaults:\n    If spec is None, then its default value will be: Spec()");

    m.def("plot_bubbles",
        [](const char * label_id, py::array & xs, py::array & ys, py::array & szs, const std::optional<const ImPlotSpec> & spec = std::nullopt)
        {
            auto PlotBubbles_adapt_c_buffers = [](const char * label_id, py::array & xs, py::array & ys, py::array & szs, const ImPlotSpec & spec = ImPlotSpec())
            {
                // Check if the array is 1D and C-contiguous
                if (! (xs.ndim() == 1 && xs.strides(0) == xs.itemsize()))
                    throw std::runtime_error("The array must be 1D and contiguous");
            ...
            auto PlotBubbles_adapt_mutable_param_with_default_value = [&PlotBubbles_adapt_c_buffers](const char * label_id, py::array & xs, py::array & ys, py::array & szs, const std::optional<const ImPlotSpec> & spec = std::nullopt)
            {
        ...
        py::arg("label_id"), py::arg("xs"), py::arg("ys"), py::arg("szs"), py::arg("spec").none() = py::none(),
        "Python bindings defaults:\n    If spec is None, then its default value will be: Spec()");

    m.def("plot_polygon",
        [](const char * label_id, py::array & xs, py::array & ys, const std::optional<const ImPlotSpec> & spec = std::nullopt)
        {
            auto PlotPolygon_adapt_c_buffers = [](const char * label_id, py::array & xs, py::array & ys, const ImPlotSpec & spec = ImPlotSpec())
            {
                // Check if the array is 1D and C-contiguous
                if (! (xs.ndim() == 1 && xs.strides(0) == xs.itemsize()))
                    throw std::runtime_error("The array must be 1D and contiguous");
            ...
            auto PlotPolygon_adapt_mutable_param_with_default_value = [&PlotPolygon_adapt_c_buffers](const char * label_id, py::array & xs, py::array & ys, const std::optional<const ImPlotSpec> & spec = std::nullopt)
            {
    ...
    m.def("plot_stairs",
        [](const char * label_id, py::array & values, double xscale = 1, double xstart = 0, const std::optional<const ImPlotSpec> & spec = std::nullopt)
        {
            auto PlotStairs_adapt_c_buffers = [](const char * label_id, py::array & values, double xscale = 1, double xstart = 0, const ImPlotSpec & spec = ImPlotSpec())
            {
                // Check if the array is 1D and C-contiguous
                if (! (values.ndim() == 1 && values.strides(0) == values.itemsize()))
                    throw std::runtime_error("The array must be 1D and contiguous");
            ...
            auto PlotStairs_adapt_mutable_param_with_default_value = [&PlotStairs_adapt_c_buffers](const char * label_id, py::array & values, double xscale = 1, double xstart = 0, const std::optional<const ImPlotSpec> & spec = std::nullopt)
            {
    ...
    m.def("plot_stairs",
        [](const char * label_id, py::array & xs, py::array & ys, const std::optional<const ImPlotSpec> & spec = std::nullopt)
        {
            auto PlotStairs_adapt_c_buffers = [](const char * label_id, py::array & xs, py::array & ys, const ImPlotSpec & spec = ImPlotSpec())
            {
                // Check if the array is 1D and C-contiguous
                if (! (xs.ndim() == 1 && xs.strides(0) == xs.itemsize()))
                    throw std::runtime_error("The array must be 1D and contiguous");
            ...
            auto PlotStairs_adapt_mutable_param_with_default_value = [&PlotStairs_adapt_c_buffers](const char * label_id, py::array & xs, py::array & ys, const std::optional<const ImPlotSpec> & spec = std::nullopt)
            {
    ...
    m.def("plot_shaded",
        [](const char * label_id, py::array & values, double yref = 0, double xscale = 1, double xstart = 0, const std::optional<const ImPlotSpec> & spec = std::nullopt)
        {
            auto PlotShaded_adapt_c_buffers = [](const char * label_id, py::array & values, double yref = 0, double xscale = 1, double xstart = 0, const ImPlotSpec & spec = ImPlotSpec())
            {
                // Check if the array is 1D and C-contiguous
                if (! (values.ndim() == 1 && values.strides(0) == values.itemsize()))
                    throw std::runtime_error("The array must be 1D and contiguous");
            ...
            auto PlotShaded_adapt_mutable_param_with_default_value = [&PlotShaded_adapt_c_buffers](const char * label_id, py::array & values, double yref = 0, double xscale = 1, double xstart = 0, const std::optional<const ImPlotSpec> & spec = std::nullopt)
            {
        ...
        py::arg("label_id"), py::arg("values"), py::arg("yref") = 0, py::arg("xscale") = 1, py::arg("xstart") = 0, py::arg("spec").none() = py::none(),
        "Python bindings defaults:\n    If spec is None, then its default value will be: Spec()");

    m.def("plot_shaded",
        [](const char * label_id, py::array & xs, py::array & ys, double yref = 0, const std::optional<const ImPlotSpec> & spec = std::nullopt)
        {
            auto PlotShaded_adapt_c_buffers = [](const char * label_id, py::array & xs, py::array & ys, double yref = 0, const ImPlotSpec & spec = ImPlotSpec())
            {
                // Check if the array is 1D and C-contiguous
                if (! (xs.ndim() == 1 && xs.strides(0) == xs.itemsize()))
                    throw std::runtime_error("The array must be 1D and contiguous");
            ...
            auto PlotShaded_adapt_mutable_param_with_default_value = [&PlotShaded_adapt_c_buffers](const char * label_id, py::array & xs, py::array & ys, double yref = 0, const std::optional<const ImPlotSpec> & spec = std::nullopt)
            {
        ...
        py::arg("label_id"), py::arg("xs"), py::arg("ys"), py::arg("yref") = 0, py::arg("spec").none() = py::none(),
        "Python bindings defaults:\n    If spec is None, then its default value will be: Spec()");

    m.def("plot_shaded",
        [](const char * label_id, py::array & xs, py::array & ys1, py::array & ys2, const std::optional<const ImPlotSpec> & spec = std::nullopt)
        {
            auto PlotShaded_adapt_c_buffers = [](const char * label_id, py::array & xs, py::array & ys1, py::array & ys2, const ImPlotSpec & spec = ImPlotSpec())
            {
                // Check if the array is 1D and C-contiguous
                if (! (xs.ndim() == 1 && xs.strides(0) == xs.itemsize()))
                    throw std::runtime_error("The array must be 1D and contiguous");
                ...
                // Compute the letter code for the buffer type
                char ys2_type = pybind11_array_type_to_letter_code(ys2);
            ...
            auto PlotShaded_adapt_mutable_param_with_default_value = [&PlotShaded_adapt_c_buffers](const char * label_id, py::array & xs, py::array & ys1, py::array & ys2, const std::optional<const ImPlotSpec> & spec = std::nullopt)
            {
        ...
        py::arg("label_id"), py::arg("xs"), py::arg("ys1"), py::arg("ys2"), py::arg("spec").none() = py::none(),
        "Python bindings defaults:\n    If spec is None, then its default value will be: Spec()");

    m.def("plot_bars",
        [](const char * label_id, py::array & values, double bar_size = 0.67, double shift = 0, const std::optional<const ImPlotSpec> & spec = std::nullopt)
        {
            auto PlotBars_adapt_c_buffers = [](const char * label_id, py::array & values, double bar_size = 0.67, double shift = 0, const ImPlotSpec & spec = ImPlotSpec())
            {
                // Check if the array is 1D and C-contiguous
                if (! (values.ndim() == 1 && values.strides(0) == values.itemsize()))
                    throw std::runtime_error("The array must be 1D and contiguous");
            ...
            auto PlotBars_adapt_mutable_param_with_default_value = [&PlotBars_adapt_c_buffers](const char * label_id, py::array & values, double bar_size = 0.67, double shift = 0, const std::optional<const ImPlotSpec> & spec = std::nullopt)
            {
        ...
        py::arg("label_id"), py::arg("values"), py::arg("bar_size") = 0.67, py::arg("shift") = 0, py::arg("spec").none() = py::none(),
        "Python bindings defaults:\n    If spec is None, then its default value will be: Spec()");

    m.def("plot_bars",
        [](const char * label_id, py::array & xs, py::array & ys, double bar_size, const std::optional<const ImPlotSpec> & spec = std::nullopt)
        {
            auto PlotBars_adapt_c_buffers = [](const char * label_id, py::array & xs, py::array & ys, double bar_size, const ImPlotSpec & spec = ImPlotSpec())
            {
                // Check if the array is 1D and C-contiguous
                if (! (xs.ndim() == 1 && xs.strides(0) == xs.itemsize()))
                    throw std::runtime_error("The array must be 1D and contiguous");
            ...
            auto PlotBars_adapt_mutable_param_with_default_value = [&PlotBars_adapt_c_buffers](const char * label_id, py::array & xs, py::array & ys, double bar_size, const std::optional<const ImPlotSpec> & spec = std::nullopt)
            {
        ...
        py::arg("label_id"), py::arg("xs"), py::arg("ys"), py::arg("bar_size"), py::arg("spec").none() = py::none(),
        "Python bindings defaults:\n    If spec is None, then its default value will be: Spec()");
    // #ifdef IMGUI_BUNDLE_PYTHON_API
    //

    m.def("plot_bar_groups",
        [](const std::vector<std::string> & label_ids, py::array & values, double group_size = 0.67, double shift = 0, const std::optional<const ImPlotSpec> & spec = std::nullopt)
        {
            auto PlotBarGroups_adapt_c_buffers = [](const std::vector<std::string> & label_ids, py::array & values, double group_size = 0.67, double shift = 0, const ImPlotSpec & spec = ImPlotSpec())
            {
                // Check if the array is 1D and C-contiguous
                if (! (values.ndim() == 1 && values.strides(0) == values.itemsize()))
                    throw std::runtime_error("The array must be 1D and contiguous");
            ...
            auto PlotBarGroups_adapt_mutable_param_with_default_value = [&PlotBarGroups_adapt_c_buffers](const std::vector<std::string> & label_ids, py::array & values, double group_size = 0.67, double shift = 0, const std::optional<const ImPlotSpec> & spec = std::nullopt)
            {
        ...
        py::arg("label_ids"), py::arg("values"), py::arg("group_size") = 0.67, py::arg("shift") = 0, py::arg("spec").none() = py::none(),
    ...
    m.def("plot_error_bars",
        [](const char * label_id, py::array & xs, py::array & ys, py::array & err, const std::optional<const ImPlotSpec> & spec = std::nullopt)
        {
            auto PlotErrorBars_adapt_c_buffers = [](const char * label_id, py::array & xs, py::array & ys, py::array & err, const ImPlotSpec & spec = ImPlotSpec())
            {
                // Check if the array is 1D and C-contiguous
                if (! (xs.ndim() == 1 && xs.strides(0) == xs.itemsize()))
                    throw std::runtime_error("The array must be 1D and contiguous");
                ...
                // Compute the letter code for the buffer type
                char err_type = pybind11_array_type_to_letter_code(err);
            ...
            auto PlotErrorBars_adapt_mutable_param_with_default_value = [&PlotErrorBars_adapt_c_buffers](const char * label_id, py::array & xs, py::array & ys, py::array & err, const std::optional<const ImPlotSpec> & spec = std::nullopt)
            {
        ...
        py::arg("label_id"), py::arg("xs"), py::arg("ys"), py::arg("err"), py::arg("spec").none() = py::none(),
        "Python bindings defaults:\n    If spec is None, then its default value will be: Spec()");

    m.def("plot_error_bars",
        [](const char * label_id, py::array & xs, py::array & ys, py::array & neg, py::array & pos, const std::optional<const ImPlotSpec> & spec = std::nullopt)
        {
            auto PlotErrorBars_adapt_c_buffers = [](const char * label_id, py::array & xs, py::array & ys, py::array & neg, py::array & pos, const ImPlotSpec & spec = ImPlotSpec())
            {
                // Check if the array is 1D and C-contiguous
                if (! (xs.ndim() == 1 && xs.strides(0) == xs.itemsize()))
                    throw std::runtime_error("The array must be 1D and contiguous");
                ...
                // Compute the letter code for the buffer type
                char pos_type = pybind11_array_type_to_letter_code(pos);
            ...
            auto PlotErrorBars_adapt_mutable_param_with_default_value = [&PlotErrorBars_adapt_c_buffers](const char * label_id, py::array & xs, py::array & ys, py::array & neg, py::array & pos, const std::optional<const ImPlotSpec> & spec = std::nullopt)
            {
        ...
        py::arg("label_id"), py::arg("xs"), py::arg("ys"), py::arg("neg"), py::arg("pos"), py::arg("spec").none() = py::none(),
        "Python bindings defaults:\n    If spec is None, then its default value will be: Spec()");

    m.def("plot_stems",
        [](const char * label_id, py::array & values, double ref = 0, double scale = 1, double start = 0, const std::optional<const ImPlotSpec> & spec = std::nullopt)
        {
            auto PlotStems_adapt_c_buffers = [](const char * label_id, py::array & values, double ref = 0, double scale = 1, double start = 0, const ImPlotSpec & spec = ImPlotSpec())
            {
                // Check if the array is 1D and C-contiguous
                if (! (values.ndim() == 1 && values.strides(0) == values.itemsize()))
                    throw std::runtime_error("The array must be 1D and contiguous");
            ...
            auto PlotStems_adapt_mutable_param_with_default_value = [&PlotStems_adapt_c_buffers](const char * label_id, py::array & values, double ref = 0, double scale = 1, double start = 0, const std::optional<const ImPlotSpec> & spec = std::nullopt)
            {
        ...
        py::arg("label_id"), py::arg("values"), py::arg("ref") = 0, py::arg("scale") = 1, py::arg("start") = 0, py::arg("spec").none() = py::none(),
        "Python bindings defaults:\n    If spec is None, then its default value will be: Spec()");

    m.def("plot_stems",
        [](const char * label_id, py::array & xs, py::array & ys, double ref = 0, const std::optional<const ImPlotSpec> & spec = std::nullopt)
        {
            auto PlotStems_adapt_c_buffers = [](const char * label_id, py::array & xs, py::array & ys, double ref = 0, const ImPlotSpec & spec = ImPlotSpec())
            {
                // Check if the array is 1D and C-contiguous
                if (! (xs.ndim() == 1 && xs.strides(0) == xs.itemsize()))
                    throw std::runtime_error("The array must be 1D and contiguous");
            ...
            auto PlotStems_adapt_mutable_param_with_default_value = [&PlotStems_adapt_c_buffers](const char * label_id, py::array & xs, py::array & ys, double ref = 0, const std::optional<const ImPlotSpec> & spec = std::nullopt)
            {
        ...
        py::arg("label_id"), py::arg("xs"), py::arg("ys"), py::arg("ref") = 0, py::arg("spec").none() = py::none(),
        "Python bindings defaults:\n    If spec is None, then its default value will be: Spec()");

    m.def("plot_inf_lines",
        [](const char * label_id, py::array & values, const std::optional<const ImPlotSpec> & spec = std::nullopt)
        {
            auto PlotInfLines_adapt_c_buffers = [](const char * label_id, py::array & values, const ImPlotSpec & spec = ImPlotSpec())
            {
                // Check if the array is 1D and C-contiguous
                if (! (values.ndim() == 1 && values.strides(0) == values.itemsize()))
                    throw std::runtime_error("The array must be 1D and contiguous");
            ...
            auto PlotInfLines_adapt_mutable_param_with_default_value = [&PlotInfLines_adapt_c_buffers](const char * label_id, py::array & values, const std::optional<const ImPlotSpec> & spec = std::nullopt)
            {
        ...
        py::arg("label_id"), py::arg("values"), py::arg("spec").none() = py::none(),
        " Plots infinite vertical or horizontal lines (e.g. for references or asymptotes).\n\n\nPython bindings defaults:\n    If spec is None, then its default value will be: Spec()");

    m.def("plot_pie_chart",
        [](const std::vector<std::string> & label_ids, py::array & values, double x, double y, double radius, const char * label_fmt = "%.1f", double angle0 = 90, const std::optional<const ImPlotSpec> & spec = std::nullopt)
        {
            auto PlotPieChart_adapt_c_buffers = [](const char * const label_ids[], py::array & values, double x, double y, double radius, const char * label_fmt = "%.1f", double angle0 = 90, const ImPlotSpec & spec = ImPlotSpec())
            {
                // Check if the array is 1D and C-contiguous
                if (! (values.ndim() == 1 && values.strides(0) == values.itemsize()))
                    throw std::runtime_error("The array must be 1D and contiguous");
            ...
            auto PlotPieChart_adapt_mutable_param_with_default_value = [&PlotPieChart_adapt_c_buffers](const char * const label_ids[], py::array & values, double x, double y, double radius, const char * label_fmt = "%.1f", double angle0 = 90, const std::optional<const ImPlotSpec> & spec = std::nullopt)
            {
            ...
            auto PlotPieChart_adapt_c_string_list_no_count = [&PlotPieChart_adapt_mutable_param_with_default_value](const std::vector<std::string> & label_ids, py::array & values, double x, double y, double radius, const char * label_fmt = "%.1f", double angle0 = 90, const std::optional<const ImPlotSpec> & spec = std::nullopt)
            {
        ...
        py::arg("label_ids"), py::arg("values"), py::arg("x"), py::arg("y"), py::arg("radius"), py::arg("label_fmt") = "%.1f", py::arg("angle0") = 90, py::arg("spec").none() = py::none(),
        "Python bindings defaults:\n    If spec is None, then its default value will be: Spec()");

    m.def("plot_histogram",
        [](const char * label_id, py::array & values, int bins = ImPlotBin_Sturges, double bar_scale = 1.0, const std::optional<const ImPlotRange> & range = std::nullopt, const std::optional<const ImPlotSpec> & spec = std::nullopt) -> double
        {
            auto PlotHistogram_adapt_c_buffers = [](const char * label_id, py::array & values, int bins = ImPlotBin_Sturges, double bar_scale = 1.0, ImPlotRange range = ImPlotRange(), const ImPlotSpec & spec = ImPlotSpec()) -> double
            {
                // Check if the array is 1D and C-contiguous
                if (! (values.ndim() == 1 && values.strides(0) == values.itemsize()))
                    throw std::runtime_error("The array must be 1D and contiguous");
            ...
            auto PlotHistogram_adapt_mutable_param_with_default_value = [&PlotHistogram_adapt_c_buffers](const char * label_id, py::array & values, int bins = ImPlotBin_Sturges, double bar_scale = 1.0, const std::optional<const ImPlotRange> & range = std::nullopt, const std::optional<const ImPlotSpec> & spec = std::nullopt) -> double
            {
        ...
        py::arg("label_id"), py::arg("values"), py::arg("bins") = ImPlotBin_Sturges, py::arg("bar_scale") = 1.0, py::arg("range").none() = py::none(), py::arg("spec").none() = py::none(),
    ...
    m.def("plot_histogram_2d",
        [](const char * label_id, py::array & xs, py::array & ys, int x_bins = ImPlotBin_Sturges, int y_bins = ImPlotBin_Sturges, const std::optional<const ImPlotRect> & range = std::nullopt, const std::optional<const ImPlotSpec> & spec = std::nullopt) -> double
        {
            auto PlotHistogram2D_adapt_c_buffers = [](const char * label_id, py::array & xs, py::array & ys, int x_bins = ImPlotBin_Sturges, int y_bins = ImPlotBin_Sturges, ImPlotRect range = ImPlotRect(), const ImPlotSpec & spec = ImPlotSpec()) -> double
            {
                // Check if the array is 1D and C-contiguous
                if (! (xs.ndim() == 1 && xs.strides(0) == xs.itemsize()))
                    throw std::runtime_error("The array must be 1D and contiguous");
            ...
            auto PlotHistogram2D_adapt_mutable_param_with_default_value = [&PlotHistogram2D_adapt_c_buffers](const char * label_id, py::array & xs, py::array & ys, int x_bins = ImPlotBin_Sturges, int y_bins = ImPlotBin_Sturges, const std::optional<const ImPlotRect> & range = std::nullopt, const std::optional<const ImPlotSpec> & spec = std::nullopt) -> double
            {
        ...
        py::arg("label_id"), py::arg("xs"), py::arg("ys"), py::arg("x_bins") = ImPlotBin_Sturges, py::arg("y_bins") = ImPlotBin_Sturges, py::arg("range").none() = py::none(), py::arg("spec").none() = py::none(),
    ...
    m.def("plot_digital",
        [](const char * label_id, py::array & xs, py::array & ys, const std::optional<const ImPlotSpec> & spec = std::nullopt)
        {
            auto PlotDigital_adapt_c_buffers = [](const char * label_id, py::array & xs, py::array & ys, const ImPlotSpec & spec = ImPlotSpec())
            {
                // Check if the array is 1D and C-contiguous
                if (! (xs.ndim() == 1 && xs.strides(0) == xs.itemsize()))
                    throw std::runtime_error("The array must be 1D and contiguous");
            ...
            auto PlotDigital_adapt_mutable_param_with_default_value = [&PlotDigital_adapt_c_buffers](const char * label_id, py::array & xs, py::array & ys, const std::optional<const ImPlotSpec> & spec = std::nullopt)
            {
    ...
    m.def("plot_image",
        ...
        py::arg("label_id"), py::arg("tex_ref"), py::arg("bounds_min"), py::arg("bounds_max"), py::arg("uv0").none() = py::none(), py::arg("uv1").none() = py::none(), py::arg("tint_col").none() = py::none(), py::arg("spec").none() = py::none(),
    ...
    m.def("plot_text",
        ...
        py::arg("text"), py::arg("x"), py::arg("y"), py::arg("pix_offset").none() = py::none(), py::arg("spec").none() = py::none(),
    ...
    m.def("plot_dummy",
        ...
        py::arg("label_id"), py::arg("spec").none() = py::none(),
    ...
    m.def("drag_point",
        ...
        py::arg("id_"), py::arg("x"), py::arg("y"), py::arg("col"), py::arg("size") = 4, py::arg("flags") = 0, py::arg("out_clicked").none() = py::none(), py::arg("out_hovered").none() = py::none(), py::arg("out_held").none() = py::none(),
    ...
    m.def("drag_line_x",
        ...
        py::arg("id_"), py::arg("x"), py::arg("col"), py::arg("thickness") = 1, py::arg("flags") = 0, py::arg("out_clicked").none() = py::none(), py::arg("out_hovered").none() = py::none(), py::arg("out_held").none() = py::none(),
    ...
    m.def("drag_line_y",
        ...
        py::arg("id_"), py::arg("y"), py::arg("col"), py::arg("thickness") = 1, py::arg("flags") = 0, py::arg("out_clicked").none() = py::none(), py::arg("out_hovered").none() = py::none(), py::arg("out_held").none() = py::none(),
    ...
    m.def("drag_rect",
        ...
        py::arg("id_"), py::arg("x1"), py::arg("y1"), py::arg("x2"), py::arg("y2"), py::arg("col"), py::arg("flags") = 0, py::arg("out_clicked").none() = py::none(), py::arg("out_hovered").none() = py::none(), py::arg("out_held").none() = py::none(),
    ...
    m.def("pixels_to_plot",
        ...
        py::arg("pix"), py::arg("x_axis").none() = py::none(), py::arg("y_axis").none() = py::none(),
        "Python bindings defaults:\n    If any of the params below is None, then its default value below will be used:\n        * x_axis: IMPLOT_AUTO\n        * y_axis: IMPLOT_AUTO");
    ...
    m.def("pixels_to_plot",
        ...
        py::arg("x"), py::arg("y"), py::arg("x_axis").none() = py::none(), py::arg("y_axis").none() = py::none(),
        "Python bindings defaults:\n    If any of the params below is None, then its default value below will be used:\n        * x_axis: IMPLOT_AUTO\n        * y_axis: IMPLOT_AUTO");
    ...
    m.def("plot_to_pixels",
        ...
        py::arg("plt"), py::arg("x_axis").none() = py::none(), py::arg("y_axis").none() = py::none(),
        "Python bindings defaults:\n    If any of the params below is None, then its default value below will be used:\n        * x_axis: IMPLOT_AUTO\n        * y_axis: IMPLOT_AUTO");
    ...
    m.def("get_plot_mouse_pos",
        ...
        py::arg("x_axis").none() = py::none(), py::arg("y_axis").none() = py::none(),
    ...
    m.def("hide_next_item",
        ...
        py::arg("hidden") = true, py::arg("cond").none() = py::none(),
    ...
    m.def("get_style",
        ImPlot::GetStyle, py::return_value_policy::reference);

    m.def("set_style",
        ImPlot::SetStyle, py::arg("style"));
    ...
    m.def("get_colormap_color",
        ...
        py::arg("idx"), py::arg("cmap").none() = py::none(),
    ...
    m.def("sample_colormap",
        ...
        py::arg("t"), py::arg("cmap").none() = py::none(),
    ...
    m.def("colormap_scale",
        ...
        py::arg("label"), py::arg("scale_min"), py::arg("scale_max"), py::arg("size").none() = py::none(), py::arg("format") = "%g", py::arg("flags") = 0, py::arg("cmap").none() = py::none(),
    ...
    m.def("colormap_slider",
        ...
        py::arg("label"), py::arg("t"), py::arg("out") = py::none(), py::arg("format") = "", py::arg("cmap").none() = py::none(),
    ...
    m.def("colormap_button",
        ...
        py::arg("label"), py::arg("size").none() = py::none(), py::arg("cmap").none() = py::none(),
    ...
    m.def("bust_color_cache",
        ...
        py::arg("plot_title_id").none() = py::none(),
...
void implot_binding_manual(py::module_& m)
{
    ...
    py::class_<ImPlotPoint> pyClassImPlotPoint = *pyClassImPlotPointPtr;


    // this is an internal function that should only be called with a tuple, list or array argument
    auto cast_to_point = [](py::handle obj) -> ImPlotPoint
    {
        if (len(obj) != 2)
    ...
    m.def("add_colormap",
        [](const char * name, const py::array & cols, bool qual=true)
        {
            ...
            bool is_uint32 = pybind11_array_is_uint32(cols);
            bool is_float = pybind11_array_is_float32(cols);
    ...
    m.def("plot_heatmap",
          [](const char * label_id, const py::array & values, double scale_min = 0, double scale_max=0, const char * label_fmt="%.1f", const ImPlotPoint& bounds_min=ImPlotPoint(0,0), const ImPlotPoint& bounds_max=ImPlotPoint(1,1), const ImPlotSpec &spec = ImPlotSpec())
          {
              auto PlotHeatmap_adapt_c_buffers = [](const char * label_id, const py::array & values, double scale_min = 0, double scale_max=0, const char * label_fmt="%.1f",  const ImPlotPoint& bounds_min=ImPlotPoint(0,0), const ImPlotPoint& bounds_max=ImPlotPoint(1,1),  const ImPlotSpec &spec = ImPlotSpec())
              {
                  // convert py::array to C standard buffer (const)
                  const void * values_from_pyarray = values.data();
          ...
          py::arg("label_id"), py::arg("values"), py::arg("scale_min")= 0, py::arg("scale_max") = 0, py::arg("label_fmt")="%.1f", py::arg("bounds_min")=ImPlotPoint(0,0), py::arg("bounds_max")=ImPlotPoint(1,1), py::arg("spec")=ImPlotSpec()
    );
    ...
    pyClassImPlotPoint.def("__init__", [&cast_to_point](ImPlotPoint *self, py::tuple t) {
        new (self) ImPlotPoint();
        *self = cast_to_point(std::move(t));
    });
    pyClassImPlotPoint.def("__init__", [&cast_to_point](ImPlotPoint *self, py::list t) {
        new (self) ImPlotPoint();
        *self = cast_to_point(std::move(t));
    });
//    pyClassImPlotPoint.def("__init__", [](ImPlotPoint *self, py::array t) {
//        new (self) ImPlotPoint();
