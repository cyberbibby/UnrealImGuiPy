...
public:
	...
	struct LanguageDefinition
	{
		...
		IMGUI_API static const LanguageDefinition& Python();
	...
	{
		std::string mText;
		ColorTextEdit::Coordinates mStart;
		ColorTextEdit::Coordinates mEnd;
	...
	bool IsCursorPositionChanged() const { return mState.mCursors[mState.mCurrentCursor].mCursorPositionChanged; }
	...
	inline void ClearEntered() { mEntered = false; }
	inline bool IsEntered() const { return mEntered; }

	inline void ClearCtrlPageUpPressed() { mCtrlPageUpPressed = false; }
	inline bool IsCtrlPageUpPressed() const { return mCtrlPageUpPressed; }

	inline void ClearCtrlPageDownPressed() { mCtrlPageDownPressed = false; }
	inline bool IsCtrlPageDownPressed() const { return mCtrlPageDownPressed; }
	...
	void EnterText(const std::string& aValue);
	...
	static const Palette& GetPyCharmDarkPalette();
	...
	void InitCodeFont(ImFont* codeFont);
private:
	...
	public:
		...
		void Undo(ColorTextEdit* aEditor);
		void Redo(ColorTextEdit* aEditor);
	...
	float mTextStart;                   // position (in pixels) where a code line starts relative to the left of the ColorTextEdit.
	int  mLeftMargin;
	...
	bool mEntered = false;
	bool mCtrlPageUpPressed = false;
	bool mCtrlPageDownPressed = false;

	Palette mPaletteBase;
	Palette mPalette;
	const LanguageDefinition* mLanguageDefinition = nullptr;
	ImFont* mCodeFont = nullptr;
